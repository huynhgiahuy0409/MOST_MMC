...
public class HandlingOutItem extends DataItem {
    private String cgNo;
    ...
    private String locArea;// add locArrea 20080710
    private int locQty;// add locQty 20080710
    private double  locWgt;// add locWgt 20080710
    private double  locMsrmt;// add locMsrmt 20080710
    ...
    private String shuYn;//add 20080710 by sunny
    private String dmgYn;//add 20080626 by sunny
    private String rhdlMode;//add 20080710 by sunny
...
//    	private String rcCoNm;
 //add package
    ...
    private String whStartDt;		//The Start Day cargo got out of warehouse, added on 20101007 by DongPhuong
    private String inWhDtNo;		//The Total Day cargo lied in warehouse, added on 20101007 by DongPhuong
    
    
    private int locCount;//add sunny location count 20081202
//        private int locDmgCount;//add sunny location count 20081202
//        private int locSprCount;//add sunny location count 20081202
    ...
    // KHH.2019.02.18
    private Date hdlOutStDt;
    private Date hdlOutEndDt;
...
//        }
    ...
    public Date getHdlOutEndDt() {
        return hdlOutEndDt;
    }
    public void setHdlOutEndDt(Date hdlOutEndDt) {
        this.hdlOutEndDt = hdlOutEndDt;
    }
    public Date getHdlOutStDt() {
        return hdlOutStDt;
    }
    public void setHdlOutStDt(Date hdlOutStDt) {
