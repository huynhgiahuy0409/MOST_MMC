...
public class VORLiquidBulkItem  extends DataItem {
    ...
    private ArrayList<VORLiquidBulkItem> vslShifting;
	...
	public ArrayList<VORLiquidBulkItem> getVslShifting() {
		return vslShifting;
	}
	public void setVslShifting(ArrayList<VORLiquidBulkItem> vslShifting) {
		this.vslShifting = vslShifting;
	}
