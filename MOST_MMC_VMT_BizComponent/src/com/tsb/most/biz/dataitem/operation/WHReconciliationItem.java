...
public class WHReconciliationItem extends DataItem {
    ...
    private List<WHReconciliationItem> detailList;
	...
	public List<WHReconciliationItem> getDetailList() {
		return detailList;
	}
	public void setDetailList(List<WHReconciliationItem> detailList) {
