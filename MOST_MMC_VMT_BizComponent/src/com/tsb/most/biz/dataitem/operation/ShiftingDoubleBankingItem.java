...
public class ShiftingDoubleBankingItem extends DataItem {
	...
	public String getAtaDtNoSecond() {
		return ataDtNoSecond;
	}
	public void setAtaDtNoSecond(String ataDtNoSecond) {
		this.ataDtNoSecond = ataDtNoSecond;
	}
