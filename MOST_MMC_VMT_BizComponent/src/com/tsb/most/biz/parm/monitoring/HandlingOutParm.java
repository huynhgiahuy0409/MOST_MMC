...
public class HandlingOutParm extends BaseBizParm {
    ...
    private String spCaCoCd;/// add by sunny kim 20090508
    private String jobCoCd;/// add by sunny kim 20090508
    private String delvTpCd;/// add by sunny kim 20090508
    private String shipgNoteNo;/// add by sunny kim 20090508
    private String cgTpCd;/// add by sunny kim 20090508
    private String rhdlNo;/// add by sunny kim 20090508
    private String rhdlMode;// add by sunny kim 20090508
    private String blSn;
    ...
    private String orgRefNo; //added by Vin - 20190309 - Confirm Rehandle Handling Out screen
    /**
