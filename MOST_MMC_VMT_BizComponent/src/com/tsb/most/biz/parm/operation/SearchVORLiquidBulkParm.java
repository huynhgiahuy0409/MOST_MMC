...
public class SearchVORLiquidBulkParm extends BaseBizParm{
    ...
    private String delayTpCd;
    private String delayCatgCd; 
    private String delayCgTp;
    private String delayCd;
    
    
	public String getDelayCatgCd() {
		return delayCatgCd;
	}

	public void setDelayCatgCd(String delayCatgCd) {
		this.delayCatgCd = delayCatgCd;
	}

	public String getDelayCgTp() {
		return delayCgTp;
	}

	public void setDelayCgTp(String delayCgTp) {
		this.delayCgTp = delayCgTp;
	}

	public String getDelayCd() {
		return delayCd;
	}

	public void setDelayCd(String delayCd) {
		this.delayCd = delayCd;
	}

	public String getDelayTpCd() {
		return delayTpCd;
	}

	public void setDelayTpCd(String delayTpCd) {
		this.delayTpCd = delayTpCd;
	}
