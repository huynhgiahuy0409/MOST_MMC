...
public class GateOperationDao extends BaseDao implements IGateOperationDao {
	...
	public DataItemList selectGrInfo(SearchGateOperationParm parm) throws DaoException {
		try{
			...
			DataItem item =  (DataItem)unifiedDao.readOne("gateoperation.selectGrInfo", parm);
			itemList.add(item);
			return itemList;
	...
	public DataItemList selectBlDoInfo(SearchGateOperationParm parm) throws DaoException {
		try{
			DataItemList itemList = new DataItemList();
			DataItem item =  (DataItem)unifiedDao.readOne("gateoperation.selectBlDoInfo", parm);
			itemList.add(item);
			return itemList;
	...
	public DataItemList selectCargoLorryGateIn(SearchGateOperationParm parm) throws DaoException {    	
		try{
			return unifiedDao.getItems("gateoperation.selectCargoInfoForGateIn", parm);
		}catch(Exception e){
			throw new DaoException(e);
		}
	}
	...
	public DataItemList selectCargoLorryGateOut(SearchGateOperationParm parm) throws DaoException {    	
		try{
			return unifiedDao.getItems("gateoperation.selectCargoInfoForGateOut", parm);
		}catch(Exception e){
			throw new DaoException(e);
		}
	}
	...
	@Override
	public DataItemList selectGCGateOutItems(SearchGateOperationParm parm) throws DaoException {
		try{
			return unifiedDao.getItems("gateoperation.selectCargoInfoForGateOut", parm);
		}catch(Exception e){
			throw new DaoException(e);
	...
	@Override
	public DataItemList selectQRTruckAssigedDetail(SearchGateOperationParm parm) throws DaoException {
		try{
			return unifiedDao.getItems("gateoperation.selectQRTruckAssigedDetail", parm);
		}catch(Exception e){
			throw new DaoException(e);
		}
	}
