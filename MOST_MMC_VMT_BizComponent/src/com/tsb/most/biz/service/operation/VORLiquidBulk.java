...
public class VORLiquidBulk extends MOSTBaseService implements IVORLiquidBulk{
    ...
    public DataItemList selectVORLiquidBulkDetail(SearchVORLiquidBulkParm parm) throws BizException {
    	...
    	ArrayList<VORLiquidBulkItem> resultVesselShifting = (ArrayList<VORLiquidBulkItem>)vorLiquidBulkDao.selectVesselShiftingList(parm).getCollection();
      	returnItem.setVslShifting(resultVesselShifting);
...
//    		vorLiquidBulkDao.deleteVORLiquidItems(deleteItems);
    	}
    	return returnItems;
    }
