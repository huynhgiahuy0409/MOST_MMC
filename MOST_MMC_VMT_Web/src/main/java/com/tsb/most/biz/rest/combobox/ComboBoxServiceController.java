...
public class ComboBoxServiceController extends RestBaseController{
	...
	@ResponseBody
	public RestResponse selectDocumentComboBox(SearchComboBoxServiceParm parm) throws ServiceException, Exception {
	...
	@ResponseBody
	public RestResponse selectWHComboList(SearchComboBoxServiceParm parm) throws ServiceException, Exception{
		RestResponse res = new RestResponse();
		Object obj = invokeService("MOST.comboboxService.selectComboBox",parm);
