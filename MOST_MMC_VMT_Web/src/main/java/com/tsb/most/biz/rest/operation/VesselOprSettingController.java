...
public class VesselOprSettingController extends RestBaseController {
	...
	@ResponseBody
	public RestResponse selectVesselOprSettingCommonCd(SearchVesselOprSettingParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		
		Object result = invokeService("MOST.vesselOprSetting.selectVesselOprSettingCommonCd",parm);
	...
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	public RestResponse insertEquipmentSettingList2(@RequestBody UpdateBizParm<VesselOprSettingItem> parm) throws ServiceException, Exception{
		InsertItemsBizParm insertParm = new InsertItemsBizParm();
		insertParm.addInsertItem(super.getItems(parm));
		RestResponse response = new RestResponse();
