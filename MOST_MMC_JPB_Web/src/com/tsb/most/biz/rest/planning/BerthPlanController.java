...
public class BerthPlanController extends RestBaseController {
	...
	@RequestMapping(value = "/maintenanceberths", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectBerthMaintenanceList(SearchBerthPlanParm maintenanceBerthParm)  throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		Object result = invokeService("MOST.berthPlan.selectBerthMaintenanceList",maintenanceBerthParm);
		res.setData(((DataItemList)result).getCollection());
		return res;
	}
	...
	@RequestMapping(value = "/vesselshiftinglist", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectVesselShiftingList(SearchBerthPlanParm berthPlanParm)  throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		Object result = invokeService("MOST.berthPlan.selectVesselShiftingList", berthPlanParm);
