...
@Controller
@RequestMapping("/v1/spacemovementrequest")
public class SpaceMovementRequestController  extends RestBaseController {
	...
	@RequestMapping(value = "/spcmovementrequestdetail", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectSpaceMovementRequestDetail(SearchSpaceMovementPlanParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();
	...
	@RequestMapping(value = "/spcmovementrequestdetail", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/spcmovementrequestdetail/{id}", method = RequestMethod.PUT)
	@ResponseBody
	...
	@RequestMapping(value = "/spcmovementrequestdetail/{id}", method = RequestMethod.DELETE)
	@ResponseBody
	...
	@RequestMapping(value = "/cargo-info", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse getCargoInfo(SearchSpaceMovementPlanParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		Object result = invokeService("MOST.spaceMovementPlan.getCargoInfo", parm);
	...
	@RequestMapping(value = "/duplicated-request", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse getDuplicatedRequest(SearchSpaceMovementPlanParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		Object result = invokeService("MOST.spaceMovementPlan.getDuplicatedRequest", parm);
