...
public class MegaController  extends RestBaseController {
	...
	@RequestMapping(value = "/manpowerList", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectMegaManpowerList(SearchMegaParm parm) throws ServiceException, Exception {
		Object obj = this.invokeService("MOST.mega.selectMegaManpowerList", parm);
		RestResponse res = new RestResponse();
