...
public class VesselScheduleInternalController extends RestBaseController{
	...
	@RequestMapping(value = "/tankerSubmission", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectTankerSubmissionItems(SearchVesselScheduleParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		Object obj = invokeService("MOST.vesselScheduleInternal.selectTankerSubmissionItems", parm);
	...
	@RequestMapping(value = "/tankerSubmission", method = RequestMethod.POST)
	@ResponseStatus(HttpStatus.CREATED)
	@ResponseBody
	public RestResponse processTankerSubmissionItems(@RequestBody UpdateBizParm<VesselScheduleItem> parm) throws ServiceException, Exception{
		UpdateItemsBizParm updateParm = new UpdateItemsBizParm();
		updateParm.setUpdateItems(super.getItems(parm));
		
		Object result = invokeService("MOST.vesselScheduleInternal.processTankerSubmissionItems", updateParm);
