...
public class VesselOprSettingController extends RestBaseController {
	...
	@RequestMapping(value = "/isallcargoreleased", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectIsAllCargoReleased(SearchVesselOprSettingParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		
		Object result = invokeService("MOST.vesselOprSetting.selectIsAllCargoReleased",parm);
