...
public class VORLiquidBulkController extends RestBaseController {
	...
	@RequestMapping(value = "/tankerTime", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectTankerTimeItem(SearchVORLiquidBulkParm parm) throws ServiceException, Exception {
		RestResponse response = new RestResponse();
		Object result = invokeService("MOST.vorLiquidBulk.selectTankerTimeItems",parm);
		response.setData(((DataItemList)result).getCollection());
		return response;
	}
