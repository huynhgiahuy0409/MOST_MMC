...
public interface IComboboxServiceDao {
	...
	public DataItemList selectWHComboList(SearchComboBoxServiceParm parm) throws DaoException;
	...
	public DataItemList selectShippingNoteSuggestionListForGateOperation(SearchComboBoxServiceParm parm) throws DaoException;
	public DataItemList selectTruckSuggestionListList(SearchComboBoxServiceParm parm) throws DaoException;
