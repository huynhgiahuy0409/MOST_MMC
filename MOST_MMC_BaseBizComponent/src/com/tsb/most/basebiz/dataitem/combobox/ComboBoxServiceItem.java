package com.tsb.most.basebiz.dataitem.combobox;
 ...
 */
public class ComboBoxServiceItem extends DataItem{
	...
	private String divIdDesc;
	private String selectId;
	private String selectIdDesc;
	private String selectIdTitle;
	...
	private String cs2FromVsl;
	private String cs2NxtVsl;
	private String stsNxtVSl;
	private String eqTpCd;
	...
	public String getCs2FromVsl() {
		return cs2FromVsl;
	}
	public void setCs2FromVsl(String cs2FromVsl) {
		this.cs2FromVsl = cs2FromVsl;
	}
	public String getCs2NxtVsl() {
		return cs2NxtVsl;
	}
	public void setCs2NxtVsl(String cs2NxtVsl) {
		this.cs2NxtVsl = cs2NxtVsl;
	}
	public String getStsNxtVSl() {
		return stsNxtVSl;
	}
	public void setStsNxtVSl(String stsNxtVSl) {
		this.stsNxtVSl = stsNxtVSl;
	}
	...
	public String getLorryComp() {
		return lorryComp;
	}
	public void setLorryComp(String lorryComp) {
		this.lorryComp = lorryComp;
	}
	...
	public String getSelectIdDesc() {
		return selectIdDesc;
	}
	public void setSelectIdDesc(String selectIdDesc) {
		this.selectIdDesc = selectIdDesc;
	}
	public String getSelectIdTitle() {
		return selectIdTitle;
	}
	public void setSelectIdTitle(String selectIdTitle) {
		this.selectIdTitle = selectIdTitle;
	}
	...
	public String getIvPrefix() {
		return ivPrefix;
	}
	public void setIvPrefix(String ivPrefix) {
	...
	public String getTrfRate() {
		return trfRate;
	}
	public void setTrfRate(String trfRate) {
	...
	public String getBittNm() {
		return bittNm;
	}
	public void setBittNm(String bittNm) {
		this.bittNm = bittNm;
	}
	...
	public String getDoNoGrNo() {
		return doNoGrNo;
	}
	public void setDoNoGrNo(String doNoGrNo) {
		this.doNoGrNo = doNoGrNo;
	}
