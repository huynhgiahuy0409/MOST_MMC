...
public class WarehouseDefinitionItem extends DataItem {
    ...
    private String useScts;
    private String cpCapa;
    private String locTpCd;
    private String locTpNm;
    ...
    private String rentalExpiredCheck;
    ...
    /**
     * @return Returns the useScts.
     */
    public String getUseScts() {
        return useScts;
    }

    /**
     * @param useScts The useScts to set.
     */
    public void setUseScts(String useScts) {
        this.useScts = useScts;
    }
    
    
    public String getCpCapa() {
		return cpCapa;
	}
	public void setCpCapa(String cpCapa) {
		this.cpCapa = cpCapa;
	}
	/**
	...
	public String getLocTpNm() {
		return locTpNm;
	}
	public void setLocTpNm(String locTpNm) {
		this.locTpNm = locTpNm;
	}
	...
	public String getRentalExpiredCheck() {
		return rentalExpiredCheck;
	}
	public void setRentalExpiredCheck(String rentalExpiredCheck) {
		this.rentalExpiredCheck = rentalExpiredCheck;
	}
    ...
    public String getSkht() {
        return skht;
    }
    public void setSkht(String skht) {
        this.skht = skht;
    }
