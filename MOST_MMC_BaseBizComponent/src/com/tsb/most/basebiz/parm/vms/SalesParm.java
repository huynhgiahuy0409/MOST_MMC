...
public class SalesParm extends BaseBizParm {
	...
	private 	String	salesReferenceDate;
	private 	String	salesComparisonDate;
	private 	String	salesReferenceYear;
	private 	String	salesComparisonYear;
	...
	public String getSalesReferenceDate() {
		return salesReferenceDate;
	}
	public void setSalesReferenceDate(String salesReferenceDate) {
		this.salesReferenceDate = salesReferenceDate;
	}
	public String getSalesComparisonDate() {
		return salesComparisonDate;
	}
	public void setSalesComparisonDate(String salesComparisonDate) {
		this.salesComparisonDate = salesComparisonDate;
	}
    public String getSalesReferenceYear() {
        return salesReferenceYear;
    }
    public void setSalesReferenceYear(String salesReferenceYear) {
        this.salesReferenceYear = salesReferenceYear;
    }
    public String getSalesComparisonYear() {
        return salesComparisonYear;
    }
    public void setSalesComparisonYear(String salesComparisonYear) {
        this.salesComparisonYear = salesComparisonYear;
    }
