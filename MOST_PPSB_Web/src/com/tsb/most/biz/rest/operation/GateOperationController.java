...
public class GateOperationController extends RestBaseController{
	...
	@RequestMapping(value = "/getSuggestionList", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse getSuggestionList(SearchComboBoxServiceParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		Object result = invokeService("MOST.comboboxService.getSuggestionList", parm);
