...
public class BLController extends RestBaseController{
	...
	@ResponseBody
	public RestResponse updateFileInfo(@PathVariable("id") String id, @RequestBody UpdateBizParm<BLItem> parm) throws ServiceException, Exception{
		RestResponse res = new RestResponse();
		UpdateItemsBizParm items = new UpdateItemsBizParm();
		
		items.setUpdateItems(super.getItems(parm));
		Object result = invokeService("MOST.bl.processFileInfo", items);
	 ...
	 * */
	@RequestMapping(value = "/blpkgdetail/{id}", method = RequestMethod.PUT)
	@ResponseBody		
	public RestResponse updatePackageItems(@PathVariable("id") String id, @RequestBody UpdateBizParm<BLItem> parm) throws ServiceException{
		RestResponse res = new RestResponse();
		UpdateItemsBizParm items = new UpdateItemsBizParm();
		
		items.setUpdateItems(super.getItems(parm));
		Object result = invokeService("MOST.bl.updatePackageItems", items);
	...
	@RequestMapping(value = "/updateDoWgt/{id}", method = RequestMethod.PUT)
	@ResponseBody
	public void updateDoWgt(@PathVariable("id") String id, @RequestBody UpdateBizParm<BLItem> parm) throws ServiceException{
		UpdateItemsBizParm updateParm = new UpdateItemsBizParm();
		RestResponse res = new RestResponse();
		
		updateParm.setUpdateItems(super.getItems(parm));
		Object result = invokeService("MOST.bl.updateDoWgt", updateParm);
	}
}
