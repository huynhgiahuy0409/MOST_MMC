...
public class ShippingNoteController extends RestBaseController {
	...
	@RequestMapping(value = "/filelist/{id}", method = RequestMethod.PUT)
	@ResponseBody
	public RestResponse updateFileInfo(@PathVariable("id") String id, @RequestBody UpdateBizParm<ShippingNoteItem> parm) throws ServiceException, Exception{
		RestResponse res = new RestResponse();
		UpdateItemsBizParm items = new UpdateItemsBizParm();
		
		items.setUpdateItems(super.getItems(parm));
		Object result = invokeService("MOST.shippingNote.processFileInfo", items);
	...
	/**
	 * PPSB. Update only Package Detail.
	 * */
	@RequestMapping(value = "/shippingnotepkgdetail/{id}", method = RequestMethod.PUT)
	@ResponseBody		
	public RestResponse updatePackageItems(@PathVariable("id") String id, @RequestBody UpdateBizParm<ShippingNoteItem> parm) throws ServiceException{
		RestResponse res = new RestResponse();
		UpdateItemsBizParm items = new UpdateItemsBizParm();
		
		items.setUpdateItems(super.getItems(parm));
		Object result = invokeService("MOST.shippingNote.updatePackageItems", items);
	...
	@RequestMapping(value = "/updConfirmLoadingStt/{id}", method = RequestMethod.PUT)
	@ResponseBody
	public void updConfirmLoadingStt(@PathVariable("id") String id, @RequestBody UpdateBizParm<ShippingNoteItem> parm) throws ServiceException, Exception{
		RestResponse res = new RestResponse();
		UpdateItemsBizParm items = new UpdateItemsBizParm();
		
		items.setUpdateItems(super.getItems(parm));
		Object result = invokeService("MOST.shippingNote.updConfirmLoadingStt", items);
	}
}
