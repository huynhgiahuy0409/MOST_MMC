...
public class PopupServiceController extends RestBaseController{
	...
	// Find Ship Call No (SCN)
	@RequestMapping(value = "/shipcallnopopup", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectShipCallNoList(SearchPopupServiceParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();
		Object result = null;
		
		result = invokeService("MOST.popupService.selectShipCallNoList",parm);
	...
	// Equipment List Forklift & Prime Mover
	@RequestMapping(value = "/eqlist", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse getEqList(SearchPopupServiceParm parm) throws ServerException, Exception {
		RestResponse res = new RestResponse();
		Object obj = invokeService("MOST.popupService.selectEqList",parm);
		res.setData(((DataItemList)obj).getCollection());
		return res;
	}
	...
	// Shipping Note Popup List for Gate Operation
	@RequestMapping(value = "/shippingnoteforgateoperationpopup", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse getShippingNoteListForGateOperationPopup(SearchPopupServiceParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();

		Object result = invokeService("MOST.popupService.selectShippingNoteListForGateOperationPopup", parm);
	...
	// BL/DO List for Gate Operation
	@RequestMapping(value = "/bldoforgateoperationpopup", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse getBLDOListForGateOperationPopup(SearchPopupServiceParm parm) throws ServiceException, Exception {
		RestResponse res = new RestResponse();

		Object result = invokeService("MOST.popupService.selectBLDOListForGateOperationPopup", parm);
