...
public class CargoManualCtl extends MOSTBaseService implements ICargoManualCtl {
	...
	@Override
	public DataItemList updateEquipmentInfoForDocument(UpdateItemsBizParm parm) throws BizException {
		DataItemList res = cargoManualCtlDao.updateEquipmentInfoForDocument(parm);
		return res;
	}
}
