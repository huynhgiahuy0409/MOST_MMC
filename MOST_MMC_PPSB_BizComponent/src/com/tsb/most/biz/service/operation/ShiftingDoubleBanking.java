...
//            returnItem.setConfirmationSlipInfo(cnfSlipList); // [3]
        	ArrayList<ShiftingDoubleBankingItem> blSnCombo = (ArrayList<ShiftingDoubleBankingItem>)shiftingDoubleBankingDao.selectBlSnCombo(parm).getCollection();
        	returnItem.setBlSnCombo(blSnCombo);
