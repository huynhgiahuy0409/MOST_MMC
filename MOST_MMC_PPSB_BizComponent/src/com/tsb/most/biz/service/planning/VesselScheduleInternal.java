...
public class VesselScheduleInternal extends MOSTBaseService implements IVesselScheduleInternal {
	...
	@Override
	public DataItemList selectBerthMaintenanceList(SearchVesselScheduleParm parm) throws BizException {
		DataItemList result = vesselScheduleInternalDao.selectBerthMaintenanceList(parm);
		return result;
	}
