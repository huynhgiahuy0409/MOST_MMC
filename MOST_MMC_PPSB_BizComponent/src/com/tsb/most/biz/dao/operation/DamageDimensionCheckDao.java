...
public class DamageDimensionCheckDao extends BaseDao implements IDamageDimensionCheckDao{
	...
	@Override
	public DataItemList selectTheDamageDesc(SearchDamageDimensionCheck parm) throws DaoException {
		return unifiedDao.getItems("DamageDimensionCheck.selectTheDamageDesc", parm);
	}
	
	@Override
	public DataItemList selectInforBlSN(SearchDamageDimensionCheck parm) throws DaoException {
		return unifiedDao.getItems("DamageDimensionCheck.selectInforBlSN", parm);
	}
	...
	public void insertDamageCheck(DataItemList items) throws DaoException {
		try{
			setNewVersion(items);
			unifiedDao.insertItems(null, "DamageDimensionCheck.insertDamageCheck", items);
			setVersion(items);
		}catch(Exception e){
			throw new DaoException(e);
		}
	...
	public void updateDamageCheck(DataItemList items) throws DaoException {
		try{
			setNewVersion(items);
			unifiedDao.updateItems(null,  "DamageDimensionCheck.updateDamageCheck", items);
			setVersion(items);
		}catch(Exception e){
			throw new DaoException(e);
		}
	...
	public void deleteDamageCheck(DataItemList items) throws DaoException {
    	try{
			setNewVersion(items);
			unifiedDao.deleteItems(null,  "DamageDimensionCheck.deleteDamageCheck", items);
			setVersion(items);
		}catch(Exception e){
			throw new DaoException(e);
		}
