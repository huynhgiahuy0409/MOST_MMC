...
public class CargoManualCtlDao extends BaseDao implements ICargoManualCtlDao {
	...
	@Override
	public DataItemList updateEquipmentInfoForDocument(UpdateItemsBizParm parm) throws DaoException {
		try {
			DataItemList updateItems = parm.getUpdateItems();
			setNewVersion(updateItems);
			unifiedDao.updateItems(null, "cargoManualCtl.updateEquipmentInfoForDocument", updateItems);
			setVersion(updateItems);
			return updateItems;
		} catch (Exception e) {
			throw new DaoException(e);
