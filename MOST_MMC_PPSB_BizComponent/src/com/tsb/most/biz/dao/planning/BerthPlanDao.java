...
public class BerthPlanDao extends BaseDao implements IBerthPlanDao {
    ...
    public DataItemList selectAmountVesselList(SearchBerthPlanParm parm) throws DaoException {
        return unifiedDao.getItems("berthPlan.selectAmountVesselList", parm);
    }
