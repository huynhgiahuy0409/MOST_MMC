...
public class VesselScheduleDao extends BaseDao implements IVesselScheduleDao {
    ...
    public DataItemList selectVesselScheduleList(SearchVesselScheduleParm parm) throws DaoException {
        ...
        {
            rtnList = unifiedDao.getItemsPage("VesselScheduleMap.selectVesselScheduleList", parm);
        }
        else
        {
            rtnList = unifiedDao.getItemsPage("VesselScheduleMap.selectVesselScheduleReport", parm);
        }
        return rtnList;
    } 
    
    public DataItemList selectVesselScheduleDetail(SearchVesselScheduleParm parm) throws DaoException {
        return unifiedDao.getItems("VesselScheduleMap.selectVesselScheduleDetail", parm);
    }
    
    public DataItemList getBerthInfoList(SearchVesselScheduleParm parm) throws DaoException {
        return unifiedDao.getItems("VesselScheduleMap.selectBerthInfo", parm);
    }
    public void updateVesselDetailItem(UpdateItemsBizParm parm) throws DaoException {
    	try{
			...
			setNewVersion(item);
			unifiedDao.updateItem(null,"VesselScheduleMap.updateItems_VesselDetail", item);
		}catch(Exception e){
