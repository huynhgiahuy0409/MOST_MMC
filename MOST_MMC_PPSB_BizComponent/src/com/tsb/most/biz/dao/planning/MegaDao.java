...
public class MegaDao extends BaseDao implements IMegaDao {
	...
	public DataItemList selectMegaContractorList(SearchMegaParm parm) throws DaoException {
		return unifiedDao.getItems("mega.selectMegaContractorList", parm);
	}
    ...
    public DataItemList selectMegaOperInfoItems(SearchMegaParm parm) throws DaoException {
        return unifiedDao.getItems("mega.selectOperInfo", parm);
    }
