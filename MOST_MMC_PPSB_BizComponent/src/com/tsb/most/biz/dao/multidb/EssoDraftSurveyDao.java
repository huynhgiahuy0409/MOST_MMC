...
public class EssoDraftSurveyDao extends BaseDao implements IEssoDraftSurveyDao {
 
	@Override
	public DataItemList getDocumentItems(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyEsso.selectDocumentItems", parm);
		} catch (Exception e) {
	...
	public DataItem getSummaryDocumentForTerminals(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyEsso.selectSummaryDocumentForTerminals", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList insertItems(InsertItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.insertItem(null, "draftSurveyEsso.insertVslDraftSurvey", vslDraftSurvey);
			unifiedDao.insertItems(null, "draftSurveyEsso.insertVslDraftSurveyDtls", vslDraftSurveyDtls);
	...
	public DataItemList deleteItems(DeleteItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.deleteItems(null, "draftSurveyEsso.deleteVslDraftSurveyItem", deleteItems);
	...
	public DataItemList checkIfReconcileStatusIsVerified(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyEsso.checkIfReconcileStatusIsVerified", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList updateItems(UpdateItemsBizParm parm) throws DaoException {
		try {
			...
			setNewVersion(vslDraftSurveyDtls);
			setNewVersion(vslDraftSurvey);
			unifiedDao.updateItem(null, "draftSurveyEsso.updateVslDraftSurvey", vslDraftSurvey);
			unifiedDao.updateItems(null, "draftSurveyEsso.updateVslDraftSurveyDtls", vslDraftSurveyDtls);
			setVersion(vslDraftSurvey);
