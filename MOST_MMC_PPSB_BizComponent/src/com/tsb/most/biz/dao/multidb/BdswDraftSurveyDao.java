...
public class BdswDraftSurveyDao extends BaseDao implements IBdswDraftSurveyDao {
 
	@Override
	public DataItemList getDocumentItems(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyBdsw.selectDocumentItems", parm);
		} catch (Exception e) {
	...
	public DataItem getSummaryDocumentForTerminals(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyBdsw.selectSummaryDocumentForTerminals", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList insertItems(InsertItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.insertItem(null, "draftSurveyBdsw.insertVslDraftSurvey", vslDraftSurvey);
			unifiedDao.insertItems(null, "draftSurveyBdsw.insertVslDraftSurveyDtls", vslDraftSurveyDtls);
	...
	public DataItemList deleteItems(DeleteItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.deleteItems(null, "draftSurveyBdsw.deleteVslDraftSurveyItem", deleteItems);
	...
	public DataItemList checkIfReconcileStatusIsVerified(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyBdsw.checkIfReconcileStatusIsVerified", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList updateItems(UpdateItemsBizParm parm) throws DaoException {
		try {
			...
			setNewVersion(vslDraftSurveyDtls);
			setNewVersion(vslDraftSurvey);
			unifiedDao.updateItem(null, "draftSurveyBdsw.updateVslDraftSurvey", vslDraftSurvey);
			unifiedDao.updateItems(null, "draftSurveyBdsw.updateVslDraftSurveyDtls", vslDraftSurveyDtls);
			setVersion(vslDraftSurvey);
