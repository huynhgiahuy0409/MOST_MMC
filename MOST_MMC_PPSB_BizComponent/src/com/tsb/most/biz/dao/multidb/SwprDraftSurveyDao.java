...
public class SwprDraftSurveyDao extends BaseDao implements ISwprDraftSurveyDao {
 
	@Override
	public DataItemList getDocumentItems(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveySwpr.selectDocumentItems", parm);
		} catch (Exception e) {
	...
	public DataItem getSummaryDocumentForTerminals(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveySwpr.selectSummaryDocumentForTerminals", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList insertItems(InsertItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.insertItem(null, "draftSurveySwpr.insertVslDraftSurvey", vslDraftSurvey);
			unifiedDao.insertItems(null, "draftSurveySwpr.insertVslDraftSurveyDtls", vslDraftSurveyDtls);
	...
	public DataItemList deleteItems(DeleteItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.deleteItems(null, "draftSurveySwpr.deleteVslDraftSurveyItem", deleteItems);
	...
	public DataItemList checkIfReconcileStatusIsVerified(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveySwpr.checkIfReconcileStatusIsVerified", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList updateItems(UpdateItemsBizParm parm) throws DaoException {
		try {
			...
			setNewVersion(vslDraftSurveyDtls);
			setNewVersion(vslDraftSurvey);
			unifiedDao.updateItem(null, "draftSurveySwpr.updateVslDraftSurvey", vslDraftSurvey);
			unifiedDao.updateItems(null, "draftSurveySwpr.updateVslDraftSurveyDtls", vslDraftSurveyDtls);
			setVersion(vslDraftSurvey);
