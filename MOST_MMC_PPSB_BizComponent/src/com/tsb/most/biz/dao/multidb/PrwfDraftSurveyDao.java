...
public class PrwfDraftSurveyDao extends BaseDao implements IPrwfDraftSurveyDao {
 
	@Override
	public DataItemList getDocumentItems(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyPrwf.selectDocumentItems", parm);
		} catch (Exception e) {
	...
	public DataItem getSummaryDocumentForTerminals(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyPrwf.selectSummaryDocumentForTerminals", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList insertItems(InsertItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.insertItem(null, "draftSurveyPrwf.insertVslDraftSurvey", vslDraftSurvey);
			unifiedDao.insertItems(null, "draftSurveyPrwf.insertVslDraftSurveyDtls", vslDraftSurveyDtls);
	...
	public DataItemList deleteItems(DeleteItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.deleteItems(null, "draftSurveyPrwf.deleteVslDraftSurveyItem", deleteItems);
	...
	public DataItemList checkIfReconcileStatusIsVerified(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyPrwf.checkIfReconcileStatusIsVerified", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList updateItems(UpdateItemsBizParm parm) throws DaoException {
		try {
			...
			setNewVersion(vslDraftSurveyDtls);
			setNewVersion(vslDraftSurvey);
			unifiedDao.updateItem(null, "draftSurveyPrwf.updateVslDraftSurvey", vslDraftSurvey);
			unifiedDao.updateItems(null, "draftSurveyPrwf.updateVslDraftSurveyDtls", vslDraftSurveyDtls);
			setVersion(vslDraftSurvey);
