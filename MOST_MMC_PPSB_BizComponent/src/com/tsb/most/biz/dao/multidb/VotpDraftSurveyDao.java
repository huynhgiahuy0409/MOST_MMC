...
public class VotpDraftSurveyDao extends BaseDao implements IVotpDraftSurveyDao {
 
	@Override
	public DataItemList getDocumentItems(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyVotp.selectDocumentItems", parm);
		} catch (Exception e) {
	...
	public DataItem getSummaryDocumentForTerminals(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyVotp.selectSummaryDocumentForTerminals", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList insertItems(InsertItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.insertItem(null, "draftSurveyVotp.insertVslDraftSurvey", vslDraftSurvey);
			unifiedDao.insertItems(null, "draftSurveyVotp.insertVslDraftSurveyDtls", vslDraftSurveyDtls);
	...
	public DataItemList deleteItems(DeleteItemsBizParm parm) throws DaoException {
		try {
			...
			unifiedDao.deleteItems(null, "draftSurveyVotp.deleteVslDraftSurveyItem", deleteItems);
	...
	public DataItemList checkIfReconcileStatusIsVerified(SearchVesselDraftSurveyParm parm) throws DaoException {
		try {
			return unifiedDao.getItems("draftSurveyVotp.checkIfReconcileStatusIsVerified", parm);
		} catch (Exception e) {
			throw new DaoException(e);
		}
	}
	...
	public DataItemList updateItems(UpdateItemsBizParm parm) throws DaoException {
		try {
			...
			setNewVersion(vslDraftSurveyDtls);
			setNewVersion(vslDraftSurvey);
			unifiedDao.updateItem(null, "draftSurveyVotp.updateVslDraftSurvey", vslDraftSurvey);
			unifiedDao.updateItems(null, "draftSurveyVotp.updateVslDraftSurveyDtls", vslDraftSurveyDtls);
			setVersion(vslDraftSurvey);
