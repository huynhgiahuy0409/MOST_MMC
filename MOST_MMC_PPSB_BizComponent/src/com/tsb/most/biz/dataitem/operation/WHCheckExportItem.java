...
public class WHCheckExportItem extends DataItem {
	...
	private String shftId;// change shiftId --> shftId
	...
	private String cgTpNm;// Dry, Break, liquid
	...
	private boolean lorryFlag = true;// add For lorry is and is not checked 2008.10.30 BY SUNNY
	private String seq;
	...
	private String facNo;// add 20080624 by sunny
	private String stevedore;// add 20080624 by sunny
	...
	private int whSumQty;
	private double whSumMt;
	private double whSumM3;
	
	private int whBalQty;
	private double whBalMt;
	private double whBalM3;
	...
	private ArrayList<WHCheckExportItem> items;
	...
	private ArrayList<WHCheckExportItem> orgCgItems;
	...
	/**
	 * @param autoDmgLocFlag
	 *            The autoDmgLocFlag to set.
	 */
	...
	/**
	 * @param autoNorLocFlag
	 *            The autoNorLocFlag to set.
	 */
	...
	/**
	 * @param autoSprLocFlag
	 *            The autoSprLocFlag to set.
	 */
	...
	public ArrayList<WHCheckExportItem> getItems() {
		return items;
	}

	public void setItems(ArrayList<WHCheckExportItem> items) {
		this.items = items;
	}
	...
	public ArrayList<WHCheckExportItem> getOrgCgItems() {
		return orgCgItems;
	}

	public void setOrgCgItems(ArrayList<WHCheckExportItem> orgCgItems) {
		this.orgCgItems = orgCgItems;
	}

	public int getWhSumQty() {
		return whSumQty;
	}

	public void setWhSumQty(int whSumQty) {
		this.whSumQty = whSumQty;
	}

	public double getWhSumMt() {
		return whSumMt;
	}

	public void setWhSumMt(double whSumMt) {
		this.whSumMt = whSumMt;
	}

	public double getWhSumM3() {
		return whSumM3;
	}

	public void setWhSumM3(double whSumM3) {
		this.whSumM3 = whSumM3;
	}

	public int getWhBalQty() {
		return whBalQty;
	}

	public void setWhBalQty(int whBalQty) {
		this.whBalQty = whBalQty;
	}

	public double getWhBalMt() {
		return whBalMt;
	}

	public void setWhBalMt(double whBalMt) {
		this.whBalMt = whBalMt;
	}

	public double getWhBalM3() {
		return whBalM3;
	}

	public void setWhBalM3(double whBalM3) {
		this.whBalM3 = whBalM3;
	}
