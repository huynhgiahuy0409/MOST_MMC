...
public class ShiftingDoubleBankingItem extends DataItem {
    ...
    private String scn;		// Mother Vessel's JPVC
    ...
    private ArrayList<ShiftingDoubleBankingItem> blSnCombo;
	...
	public ArrayList<ShiftingDoubleBankingItem> getBlSnCombo() {
		return blSnCombo;
	}
	public void setBlSnCombo(ArrayList<ShiftingDoubleBankingItem> blSnCombo) {
		this.blSnCombo = blSnCombo;
	}
