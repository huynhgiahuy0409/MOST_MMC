...
public class RehandleGCItem extends DataItem {
    ...
    private ShippingNoteItem generatedSn;
    
    
    public ShippingNoteItem getGeneratedSn() {
		return generatedSn;
	}
	public void setGeneratedSn(ShippingNoteItem generatedSn) {
		this.generatedSn = generatedSn;
	}
