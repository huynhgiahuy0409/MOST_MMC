...
public class BerthPlanItem extends DataItem {
    ...
    private String totalDSLDMt;
    private String totalDSLDQty;
    private String balanceDSLDMt;
    private String balanceDSLDQty;
    private String commodityList;
    private String unberthReason;
	...
	public String getTotalDSLDMt() {
		return totalDSLDMt;
	}
	public void setTotalDSLDMt(String totalDSLDMt) {
		this.totalDSLDMt = totalDSLDMt;
	}
	public String getTotalDSLDQty() {
		return totalDSLDQty;
	}
	public void setTotalDSLDQty(String totalDSLDQty) {
		this.totalDSLDQty = totalDSLDQty;
	}
	public String getBalanceDSLDMt() {
		return balanceDSLDMt;
	}
	public void setBalanceDSLDMt(String balanceDSLDMt) {
		this.balanceDSLDMt = balanceDSLDMt;
	}
	public String getBalanceDSLDQty() {
		return balanceDSLDQty;
	}
	public void setBalanceDSLDQty(String balanceDSLDQty) {
		this.balanceDSLDQty = balanceDSLDQty;
	}
	...
	public String getUnberthReason() {
		return unberthReason;
	}
	public void setUnberthReason(String unberthReason) {
		this.unberthReason = unberthReason;
	}
