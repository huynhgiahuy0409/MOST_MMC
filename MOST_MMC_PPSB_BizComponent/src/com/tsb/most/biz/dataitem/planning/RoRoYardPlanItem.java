...
public class RoRoYardPlanItem extends DataItem {
	...
	private ArrayList<RoRoYardPlanItem> cargoItems;
    private ArrayList<RoRoYardPlanItem> unitItems;
    private ArrayList<RoRoYardPlanItem> plannedItems;
    private ArrayList<RoRoYardPlanItem> blItems;
    private ArrayList<RoRoYardPlanItem> snItems;
	...
	public ArrayList<RoRoYardPlanItem> getCargoItems() {
		return cargoItems;
	}
	public void setCargoItems(ArrayList<RoRoYardPlanItem> cargoItems) {
		this.cargoItems = cargoItems;
	}
	public ArrayList<RoRoYardPlanItem> getUnitItems() {
		return unitItems;
	}
	public void setUnitItems(ArrayList<RoRoYardPlanItem> unitItems) {
		this.unitItems = unitItems;
	}
	public ArrayList<RoRoYardPlanItem> getPlannedItems() {
		return plannedItems;
	}
	public void setPlannedItems(ArrayList<RoRoYardPlanItem> plannedItems) {
		this.plannedItems = plannedItems;
	}
	public ArrayList<RoRoYardPlanItem> getBlItems() {
		return blItems;
	}
	public void setBlItems(ArrayList<RoRoYardPlanItem> blItems) {
		this.blItems = blItems;
	}
	public ArrayList<RoRoYardPlanItem> getSnItems() {
		return snItems;
	}
	public void setSnItems(ArrayList<RoRoYardPlanItem> snItems) {
