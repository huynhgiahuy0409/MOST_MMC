...
public class ShippingNoteItem extends DataItem { 
    ...
    //Package measure
  	private String pkgUnitQty;
  	private String pkgTotalWgt;
  	private String eachPkgWgt;	
  	private String pkgTotalVol;
  	private String eachPkgVol;
  	private String pkgAgentId;
  	private String pkgAgentRmk;
	...
	private String anchorageChk;
	private String privateJettyChk;
	private String isOperated;
	private String tsAprovalYN;
...
//	}
	...
	public String getPkgUnitQty() {
		return pkgUnitQty;
	}
	public void setPkgUnitQty(String pkgUnitQty) {
		this.pkgUnitQty = pkgUnitQty;
	}
	public String getPkgTotalWgt() {
		return pkgTotalWgt;
	}
	public void setPkgTotalWgt(String pkgTotalWgt) {
		this.pkgTotalWgt = pkgTotalWgt;
	}
	public String getEachPkgWgt() {
		return eachPkgWgt;
	}
	public void setEachPkgWgt(String eachPkgWgt) {
		this.eachPkgWgt = eachPkgWgt;
	}
	public String getPkgTotalVol() {
		return pkgTotalVol;
	}
	public void setPkgTotalVol(String pkgTotalVol) {
		this.pkgTotalVol = pkgTotalVol;
	}
	public String getEachPkgVol() {
		return eachPkgVol;
	}
	public void setEachPkgVol(String eachPkgVol) {
		this.eachPkgVol = eachPkgVol;
	}
	public String getPkgAgentId() {
		return pkgAgentId;
	}
	public void setPkgAgentId(String pkgAgentId) {
		this.pkgAgentId = pkgAgentId;
	}
	public String getPkgAgentRmk() {
		return pkgAgentRmk;
	}
	public void setPkgAgentRmk(String pkgAgentRmk) {
		this.pkgAgentRmk = pkgAgentRmk;
	}
	public String getGenerateGR() {
		return generateGR;
	}
	public void setGenerateGR(String generateGR) {
		this.generateGR = generateGR;
	}
	public String getAnchorageChk() {
		return anchorageChk;
	}
	public void setAnchorageChk(String anchorageChk) {
		this.anchorageChk = anchorageChk;
	}
	public String getPrivateJettyChk() {
		return privateJettyChk;
	}
	public void setPrivateJettyChk(String privateJettyChk) {
		this.privateJettyChk = privateJettyChk;
	}
	...
	public String gettsAprovalYN() {
		return tsAprovalYN;
	}
	public void settsAprovalYN(String tsAprovalYN) {
		this.tsAprovalYN = tsAprovalYN;
	}
