...
public class VesselScheduleInternalDao extends BaseDao implements IVesselScheduleInternalDao {
	...
	public DataItemList selectTankerSubmissionItems(SearchVesselScheduleParm parm) throws DaoException{
        return unifiedDao.getItems("vesselScheduleInternal.selectTankerSubmissionItems", parm);
    }
	
	public void insertTankerSubmissionItems(InsertItemsBizParm parm) throws DaoException {
    	try {
			DataItemList insertItems = parm.getInsertItems();
			setNewVersion(insertItems);	
			unifiedDao.insertItems(null, "vesselScheduleInternal.insertTankerSubmissionItems", insertItems);
	...
	public void updateTankerSubmissionItems(UpdateItemsBizParm parm) throws DaoException {
    	try {
			DataItemList updateItems = parm.getUpdateItems();
			setNewVersion(updateItems);	
			unifiedDao.insertItems(null, "vesselScheduleInternal.updateTankerSubmissionItems", updateItems);
	...
	public void deleteTankerSubmissionItems(DeleteItemsBizParm parm) throws DaoException {
    	try {
			DataItemList deleteItems = parm.getDeleteItems();
			unifiedDao.insertItems(null, "vesselScheduleInternal.deleteTankerSubmissionItems", deleteItems);
