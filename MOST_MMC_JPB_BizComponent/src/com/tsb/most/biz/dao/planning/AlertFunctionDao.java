...
public class AlertFunctionDao extends BaseDao implements IAlertFunctionDao {
	...
	@Override
	public DataItemList getExternalAlertFunctionList(SearchAlertFunctionParm parm) throws DaoException {
		return unifiedDao.getItems("alertfunction.selectExternalAlertFunction", parm);
	}
}
