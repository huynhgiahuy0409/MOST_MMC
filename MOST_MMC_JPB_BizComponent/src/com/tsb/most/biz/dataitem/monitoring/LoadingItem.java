...
public class LoadingItem extends DataItem {
    ...
    private String rePkgTpNm;
    private String fwrAgntNm;
    private String descrNm;
	...
	public String getRePkgTpNm() {
		return rePkgTpNm;
	}
	public void setRePkgTpNm(String rePkgTpNm) {
		this.rePkgTpNm = rePkgTpNm;
	}
	public String getFwrAgntNm() {
		return fwrAgntNm;
	}
	public void setFwrAgntNm(String fwrAgntNm) {
		this.fwrAgntNm = fwrAgntNm;
	}
	public String getDescrNm() {
		return descrNm;
	}
	public void setDescrNm(String descrNm) {
		this.descrNm = descrNm;
	}
