...
public class ImportReconcileForLiquidItem extends DataItem {
    ...
    private ArrayList<ImportReconcileForLiquidItem> items;
    private ArrayList<ImportReconcileForLiquidItem> statusitems;
	...
	public ArrayList<ImportReconcileForLiquidItem> getItems() {
		return items;
	}
	public void setItems(ArrayList<ImportReconcileForLiquidItem> items) {
		this.items = items;
	}
	public ArrayList<ImportReconcileForLiquidItem> getStatusitems() {
		return statusitems;
	}
	public void setStatusitems(ArrayList<ImportReconcileForLiquidItem> statusitems) {
