...
public class MegaItem extends DataItem {
    ...
    private String whConfmBy; // Warehouse Confirm By
    ...
    private Date whConfmDt;		// Warehouse Confirm Date
    private Date etw;
    ...
    private List<MegaItem> stevedoreItems;
    private List<MegaItem> trimmingItems;
    private List<MegaItem> operInfoItemsForStevedore;
    private List<MegaItem> operInfoItemsForTrimming;
	...
	public List<MegaItem> getStevedoreItems() {
		return stevedoreItems;
	}

	public void setStevedoreItems(List<MegaItem> stevedoreItems) {
		this.stevedoreItems = stevedoreItems;
	}

	public List<MegaItem> getTrimmingItems() {
		return trimmingItems;
	}

	public void setTrimmingItems(List<MegaItem> trimmingItems) {
		this.trimmingItems = trimmingItems;
	}

	public List<MegaItem> getOperInfoItemsForStevedore() {
		return operInfoItemsForStevedore;
	}

	public void setOperInfoItemsForStevedore(List<MegaItem> operInfoItemsForStevedore) {
		this.operInfoItemsForStevedore = operInfoItemsForStevedore;
	}

	public List<MegaItem> getOperInfoItemsForTrimming() {
		return operInfoItemsForTrimming;
	}

	public void setOperInfoItemsForTrimming(List<MegaItem> operInfoItemsForTrimming) {
		this.operInfoItemsForTrimming = operInfoItemsForTrimming;
	}
	...
	public String getDenyRmk() {
		return denyRmk;
	}
	public void setDenyRmk(String denyRmk) {
		this.denyRmk = denyRmk;
	}
	...
	public Date getWhConfmDt() {
		return whConfmDt;
	}
	public void setWhConfmDt(Date whConfmDt) {
		this.whConfmDt = whConfmDt;
	}
	public String getWhConfmBy() {
		return whConfmBy;
	}
	public void setWhConfmBy(String whConfmBy) {
		this.whConfmBy = whConfmBy;
	}
