...
public class SpaceMovementSummaryItem extends DataItem {
    ...
    private ArrayList<SpaceMovementSummaryItem> items;
	...
	public ArrayList<SpaceMovementSummaryItem> getItems() {
		return items;
	}
	public void setItems(ArrayList<SpaceMovementSummaryItem> items) {
		this.items = items;
	}
