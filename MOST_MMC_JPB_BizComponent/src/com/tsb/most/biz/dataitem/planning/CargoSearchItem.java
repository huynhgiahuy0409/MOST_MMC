...
* 2007-11-28     Mr Sunny Kim 1.0    First release.
* -------------------------------
* CLASS DESCRIPTION
* -------------------------------
*
...
public class CargoSearchItem extends DataItem {
	...
	public String getBagMt() {
		return bagMt;
	}
	public void setBagMt(String bagMt) {
		this.bagMt = bagMt;
	}
