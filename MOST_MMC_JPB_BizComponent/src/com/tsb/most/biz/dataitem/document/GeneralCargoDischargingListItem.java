...
public class GeneralCargoDischargingListItem extends DataItem {
	...
	public String getPackageTypeCd() {
		return packageTypeCd;
	}
	public void setPackageTypeCd(String packageTypeCd) {
		this.packageTypeCd = packageTypeCd;
	}
}
