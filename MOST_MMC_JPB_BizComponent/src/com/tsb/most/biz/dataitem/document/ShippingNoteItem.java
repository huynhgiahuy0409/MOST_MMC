...
public class ShippingNoteItem extends DataItem { 
    ...
    //for printing SN
    private String vslNm,inbVoyage,outbVoyage,scn,sa,saCd,saAddr1,saAddr2,saAddr3,saAddr4,berthLoc,whLoc,eta,orgCntry,cgTpNm;
...
//	}
	...
	public String getBkrChk() {
		return bkrChk;
	}
	public void setBkrChk(String bkrChk) {
		this.bkrChk = bkrChk;
	}
