...
public class CargoHandlingInItem extends DataItem {
	...
	private String whStartDt;
	private String inWhDtNo;
	...
	private ArrayList<WhConfigurationItem> shuWhItems;
	...
	public ArrayList<WhConfigurationItem> getShuWhItems() {
		return shuWhItems;
	}

	public void setShuWhItems(ArrayList<WhConfigurationItem> shuWhItems) {
		this.shuWhItems = shuWhItems;
	}
