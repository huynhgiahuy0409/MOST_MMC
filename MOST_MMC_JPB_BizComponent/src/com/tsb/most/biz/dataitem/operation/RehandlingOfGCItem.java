...
public class RehandlingOfGCItem extends DataItem {
    ...
    private ArrayList<RehandlingOfGCItem> items;
	...
	public ArrayList<RehandlingOfGCItem> getItems() {
		return items;
	}
	public void setItems(ArrayList<RehandlingOfGCItem> items) {
		this.items = items;
	}
