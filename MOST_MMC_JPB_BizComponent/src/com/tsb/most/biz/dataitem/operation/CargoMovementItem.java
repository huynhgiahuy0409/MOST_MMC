...
public class CargoMovementItem extends DataItem {
    ...
    private ArrayList<CargoMovementItem> items;
    ...
    private int zb10PkgQty;
    private double zb10Msrmt;
    private double zb10Wgt;
    
    private int zb10BalPkgQty;
    private double zb10BalMsrmt;
    private double zb10BalWgt;

    public int getZb10BalPkgQty() {
		return zb10BalPkgQty;
	}

	public void setZb10BalPkgQty(int zb10BalPkgQty) {
		this.zb10BalPkgQty = zb10BalPkgQty;
	}

	public double getZb10BalMsrmt() {
		return zb10BalMsrmt;
	}

	public void setZb10BalMsrmt(double zb10BalMsrmt) {
		this.zb10BalMsrmt = zb10BalMsrmt;
	}

	public double getZb10BalWgt() {
		return zb10BalWgt;
	}

	public void setZb10BalWgt(double zb10BalWgt) {
		this.zb10BalWgt = zb10BalWgt;
	}

	public int getZb10PkgQty() {
		return zb10PkgQty;
	}

	public void setZb10PkgQty(int zb10PkgQty) {
		this.zb10PkgQty = zb10PkgQty;
	}

	public double getZb10Msrmt() {
		return zb10Msrmt;
	}

	public void setZb10Msrmt(double zb10Msrmt) {
		this.zb10Msrmt = zb10Msrmt;
	}

	public double getZb10Wgt() {
		return zb10Wgt;
	}

	public void setZb10Wgt(double zb10Wgt) {
		this.zb10Wgt = zb10Wgt;
	}
...
//	}
	...
	public ArrayList<CargoMovementItem> getItems() {
		return items;
	}

	public void setItems(ArrayList<CargoMovementItem> items) {
		this.items = items;
	}
	...
	public void setToLocTp(String toLocTpCd) {
