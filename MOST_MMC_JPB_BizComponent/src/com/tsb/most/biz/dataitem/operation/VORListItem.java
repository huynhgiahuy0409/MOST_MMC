...
public class VORListItem extends DataItem {
    ...
    private ArrayList<VORListItem> listVOR;
    private ArrayList<VORListItem> handlingList;
    private ArrayList<VORDryBreakBulkItem> vesselInfoList;
    private ArrayList<VORListItem> items;
    private ArrayList<VORListItem> shiftedLocList;
    private ArrayList<VORListItem> shiftingList;
    private ArrayList<VORListItem> bankingList;
    
	public ArrayList<VORListItem> getShiftedLocList() {
		return shiftedLocList;
	}
	public ArrayList<VORListItem> getShiftingList() {
		return shiftingList;
	}
	public ArrayList<VORListItem> getBankingList() {
		return bankingList;
	}
	public void setShiftedLocList(ArrayList<VORListItem> shiftedLocList) {
		this.shiftedLocList = shiftedLocList;
	}
	public void setShiftingList(ArrayList<VORListItem> shiftingList) {
		this.shiftingList = shiftingList;
	}
	public void setBankingList(ArrayList<VORListItem> bankingList) {
		this.bankingList = bankingList;
	}
	public ArrayList<VORListItem> getItems() {
		return items;
	}
	public void setItems(ArrayList<VORListItem> items) {
		this.items = items;
	}

	public ArrayList<VORListItem> getHandlingList() {
		return handlingList;
	}
	public void setHandlingList(ArrayList<VORListItem> handlingList) {
		this.handlingList = handlingList;
	}
	public ArrayList<VORListItem> getListVOR() {
		return listVOR;
	}
	public void setListVOR(ArrayList<VORListItem> listVOR) {
    ...
    //-- start ADD 20080731 tnkytn Need for HHT
    private String crud;
    //-- end   ADD 20080731 tnkytn Need for HHT
