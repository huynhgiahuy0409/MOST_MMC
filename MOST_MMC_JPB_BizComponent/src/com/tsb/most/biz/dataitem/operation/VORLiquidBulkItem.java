...
public class VORLiquidBulkItem  extends DataItem {
    ...
    private ArrayList<VORLiquidBulkItem> berthAndOperationInfo;
    private ArrayList<VORLiquidBulkItem> vorSummary;
    private ArrayList<VORLiquidBulkItem> cargoSummary;
    private ArrayList<VORLiquidBulkItem> delaySummary;
    private ArrayList<VORLiquidBulkItem> vorDelaySummary;
    
    private ArrayList<VORLiquidBulkItem> amountCargoSummary;
    ...
    private ArrayList<VORLiquidBulkItem> vorLiquidBulk;
    ...
    private String tspTpCd;
    
    private String scn;
    private String eqFacNo;
    private String eqTpCd;
    private ArrayList<VORLiquidBulkItem> tankerTime;
    private String tankerSource;
	...
	public String getTankerSource() {
		return tankerSource;
	}
	public void setTankerSource(String tankerSource) {
		this.tankerSource = tankerSource;
	}
	public ArrayList<VORLiquidBulkItem> getTankerTime() {
		return tankerTime;
	}
	public void setTankerTime(ArrayList<VORLiquidBulkItem> tankerTime) {
		this.tankerTime = tankerTime;
	}
	...
	public ArrayList<VORLiquidBulkItem> getVorLiquidBulk() {
		return vorLiquidBulk;
	}
	public void setVorLiquidBulk(ArrayList<VORLiquidBulkItem> vorLiquidBulk) {
	...
	public ArrayList<VORLiquidBulkItem> getDelaySummary() {
		return delaySummary;
	}
	public void setDelaySummary(ArrayList<VORLiquidBulkItem> delaySummary) {
	...
	public ArrayList<VORLiquidBulkItem> getBerthAndOperationInfo() {
		return berthAndOperationInfo;
	}
	public void setBerthAndOperationInfo(ArrayList<VORLiquidBulkItem> berthAndOperationInfo) {
		this.berthAndOperationInfo = berthAndOperationInfo;
	}
	public ArrayList<VORLiquidBulkItem> getVorSummary() {
		return vorSummary;
	}
	public void setVorSummary(ArrayList<VORLiquidBulkItem> vorSummary) {
    ...
    /**
     * @return Returns the genOprYn.
     */
    public String getGenOprYn() {
        return genOprYn;
    }
    /**
     * @param genOprYn The genOprYn to set.
     */
    public void setGenOprYn(String genOprYn) {
        this.genOprYn = genOprYn;
    }
    /**
     * @return Returns the stsOprYn.
     */
    public String getStsOprYn() {
        return stsOprYn;
    }
    /**
     * @param stsOprYn The stsOprYn to set.
     */
...
//        return fDest;
//    }
//    public void setFDest(String dest) {
//        fDest = dest;
//    }
	...
	public ArrayList<VORLiquidBulkItem> getVorDelaySummary() {
		return vorDelaySummary;
	}
	public void setVorDelaySummary(ArrayList<VORLiquidBulkItem> vorDelaySummary) {
		this.vorDelaySummary = vorDelaySummary;
	}
	public ArrayList<VORLiquidBulkItem> getAmountCargoSummary() {
		return amountCargoSummary;
	}
	public void setAmountCargoSummary(ArrayList<VORLiquidBulkItem> amountCargoSummary) {
	...
	public String getTspTpCd() {
		return tspTpCd;
	}
	public void setTspTpCd(String tspTpCd) {
		this.tspTpCd = tspTpCd;
	}
