Ext.define('MOST.view.operation.WarehouseCheckForExportHHTController', {
	 ...
	 */
	 onWarehouseDeAllocation : function(controlName){
		...
		me.openHhtPopup('app-warehouseallocation',controlName, selection);		
	},
...
//		}
	...
	onSearchPkgTpHHT:function(refBtn){;
		...
		if(params && targetref){
			ViewUtil.openHhtPopup(this, 'app-commoncodepopuphht', targetref, params);
		}
	},
...
//		var recvData = me.prevHHTData.recvData;
		var recvData = me.getView().recvData;
		ViewUtil.openHhtPopup(this, 'app-damageofcargo', 'refsWHBtnDamage', recvData);
...
//		var recvData = me.prevHHTData.recvData;
		var recvData = me.getView().recvData;
		ViewUtil.openHhtPopup(this, 'app-dimensionofcargohht', 'refsWHBtnDimension', recvData);
	},
	...
	afterSetCodePopupData:function(xtype, targetControl, returnValue){
		...
		}else if(targetControl === 'refConfirmWarehouseInDamageBtn'){
	...
	saveProcess : function() {
		...
		var endTime =  refs.refConfirmLoadingEndDt.getValue();
		endTime = endTime ? endTime : currentTime;
		var endDtStr = Ext.Date.format(currentTime, MOST.config.Locale.getDefaultDateFormatWithNoSeconds());
			...
			callback: function(records, operation, success) {
				if (success) {
					...
					if(tblDtlDamageCheckStore.getCount() > 0){
						me.processDamage(records.data.jobNo)
					}else{
						detailItem.commit();
						// me.saveDimension();
						me.setMaskedForm(false);
	...
	onOpenTblDamageCheck: function() {
		...
		ViewUtil.openHhtPopup(me, 'app-damagecheckhhtpopup', 'refConfirmWarehouseInDamageBtn', detailItem);
	},
	/**
	 * GENERAL METHOD END
	 * =========================================================================================================================
