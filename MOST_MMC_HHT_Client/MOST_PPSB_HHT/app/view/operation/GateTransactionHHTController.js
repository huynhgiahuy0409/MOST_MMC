	...
	setDocForGateIn: function (returnValue) {
		...
		if (returnValue) {
			...
			let param = {
				...
				vslCallId: returnValue.item.vslCallId,
				blNo: returnValue.item.blNo,
				doNo: returnValue.item.doNo,
				sdoNo: returnValue.item.sdoNo,
				grNo: returnValue.item.grNo,
				shipgNoteNo: returnValue.item.shipgNoteNo,
			}
	...
	getBindingXml: function () {
		...
		if (me.tabMode === 'gateIn') {
			...
			if (theGateInBldo) {
				...
				me.insGateInData.set('sdoNo', theGateInBldo.get('sdoNo'));
