...
//	     	refs.ctlJpvc.setValue(recvData.vslCallId);
	...
	onOpenDelayCodePopup:function(field, button, e){
		...
		me.openHhtPopup('popup-delaycodepopup', 'refTxtDelayCode', params);
	},
	...
	onOpenDelayCodeHHTPopup: function (field, button, e) {
		var me = this;
			refs = me.getReferences(),
			targetCtl = 'refVesselDelayCode',
			params = {
				lcd: 'BBK',
				title: 'Delay Code'
			};

		//ViewUtil.openCodePopup(me, 'app-delaycodehhtpopup', targetCtl, params);
		ViewUtil.openHhtPopup(me, 'app-delaycodehhtpopup', targetCtl, params);
	},
	...
	onOpenStevedoreHHTPopup: function () {
		...
		ViewUtil.openHhtPopup(me, 'app-commoncodepopuphht', targetCtl, params);
	},
