Ext.define('MOST.view.operation.ConfirmHandlingOutHHTPopupController', {
	...
	onOpenTblDamageCheck: function() {
		...
		ViewUtil.openHhtPopup(me, 'app-damagecheckhhtpopup', 'refConfirmHODamageBtn', detailItem);
	},
	onCancel:function(){
		var me = this;
	...
	afterSetCodePopupData:function(xtype, targetControl, returnValue){
		...
		else if(targetControl === 'refConfirmHODamageBtn'){
		...
		if(detailItem.get('domesticChk') == 'N' &&  Token.getCustomHoldChk() === 'Y') {
			if(detailItem.get('custMode') !== me.CUST_RELEASE) {
				if(isCustomBlockProcess === 'Y'){
					...
					MessageUtil.questionModern('info_msg', 'confirmhandlingout_clearance_msg', null,
						function(button){
							if(button === 'ok'){
								me.clearanceHHT();				
							}
