...
//		this.loadNoLogin();	
		...
		//<<20240719: Robert add load LocalCacheInfo:
		var localCacheInfo = Ext.create('MOST.store.LocalCacheStore');
		localCacheInfo.load({
			callback:function(records,operation, success){
				LocalCacheServiceUtil.setLocalCacheStore(localCacheInfo);
				console.log("localCacheInfo.load success: " + success);
			}
		}); //end load LocalCacheInfo>>.
	},
