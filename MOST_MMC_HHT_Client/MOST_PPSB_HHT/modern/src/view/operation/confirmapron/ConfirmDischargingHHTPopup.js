							...
							items:[
								{//Row1.Col1.Col1 BL, Hatch, Start/End DateTime
									...
									items: [
										...
										{											
											xtype: 'combobox',
											reference: 'refTxtCfmDischargingForklift',
											label: { type: 'bundle', key: 'forklift'},
											bind:{
												store: '{forkliftCombo}',
												value : '{theDetail.forkliftNo}'
											},
											hideTrigger: true,
											...
											queryMode: 'local',
											listeners: {
												keyup: 'onEquipmentChange',
												collapse: 'onEquipmentCollapse',
											},
								...
								//Row1.Col1.Col2 EQ No, delv Mode, Package No.
								{
									...
									items: [
										...
										{											
											xtype: 'combobox',
											reference: 'refTxtCfmDischargingPrimeMover',
											label: { type: 'bundle', key: 'primeMover'},
											bind:{
												store: '{primeMoverCombo}',
