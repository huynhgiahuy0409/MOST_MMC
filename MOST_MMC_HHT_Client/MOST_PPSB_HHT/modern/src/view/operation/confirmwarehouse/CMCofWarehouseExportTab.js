Ext.define('MOST.view.operation.confirmwarehouse.CMCofWarehouseExportTab', {
	extend: 'Ext.Panel',
	alias: 'widget.app-cmcofwarehouseexporttab',
	requires: [
		'Ext.tab.Panel',
		'Ext.tab.Tab',
		'Ext.scroll.Scroller',
	...
	items:[
		{//Row1: Data Grid GR Loading Direct
			...
			items: [
				...
				},
				{
					...
					flex: 1,
					border: true,
					reference: 'refGridExportCargoManualCtlTab',
					bind: {
						store: '{cargoManualCtlTabExport}'
					},
					listeners: {
						childsingletap: 'onClickForExportTab'
					},
					selectable: {
						columns: false,
						checkbox: true,
		...
		{//Row2: Data Grid Loading InDirect (WA)
			xtype: 'fieldset',
			reference: 'refFlsSnWhCheckExport',
			hidden: true,
			flex: 1,
			border: true,				
			autoSize: true,
			...
			items: [
				{
					xtype:'label',
					style: 'color: red; font-weight: bold',
					html:'SN List - To Confirm Loading (Indirect)',
				},
				{
					xtype: 'grid',
					flex: 1,
					...
					listeners: {
						childsingletap: 'onClickForExportTab1'
					},
					selectable: {
						columns: false,
						checkbox: true,
