Ext.define('MOST.view.operation.GateTransactionHHTModel', {
	...
	stores: {
		...
		searchGateInList: {
			...
			proxy: {
				type: 'rest',
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/gateoperation/cargoarrivaldelivery'
			}
		},
		...
		gatePassChkList: {
			...
			proxy: {
				type: 'rest',
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/gateoperation/confirmgatetransaction'
			}
		},
...
//			}
		...
		grInGateList: {
			...
			proxy: {
				type: 'rest',
				showProgressBar : false,
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/gateoperation/gringatelist'
			}
		},
		...
		*/
		gateInQRScanning: {
			...
			storeId: 'gateInQRScanningStore',
			proxy: {
				type: 'rest',
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/gateoperation/gateincargolist'
			}
		},
		gateOutQRScanning: {
			model: 'MOST.model.operation.GateOperation',
			...
			proxy: {
				type: 'rest',
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/gateoperation/gateoutcargolist'
			}
		},
		blDo: {
			model: 'MOST.model.operation.GateOperation',
			...
			proxy: {
				type: 'rest',
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/gateoperation/bldoinfo'
			}
		},
		goodReceipt: {
			model: 'MOST.model.operation.GateOperation',
			storeId: 'goodReceiptStore',
			proxy: {
				type: 'rest',
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/gateoperation/grinfo'
			}
		},
	}
});