Ext.define('MOST.view.popup.VesselPopupController', {
	extend: 'MOST.view.foundation.BaseViewController',

	requires: [
	],

	alias: 'controller.vesselpopup',	
	...
	onLoad: function(){
		...
		var store = me.getStore('VesselPopupStore');
		
		var searchParm =  Ext.create('MOST.model.common.SearchVesselCall');
	...
	onSearch: function() {
    	...
    	//var win = me.lookupReference('popupAliaspopup-jpvcpopup');
...
//				}
	...
	getReturnData:function(eOpts){
		...
		var selectable;
		if(Ext.isClassic){
			var grid = me.lookupReference('refVesselPopupGrid');
			selection = grid.getSelection() == null ? null : grid.getSelection()[0];
		}
		else if(Ext.isModern){
			var grid = me.lookupReference('refVesselPopupHHTGrid');
