Ext.define('MOST.view.popup.WHCheckerSetLocPopupController', {
    extend: 'MOST.view.foundation.BaseViewController',

    requires: [],

    alias: 'controller.whcheckersetlocpopup',
    ...
    onLoadCombo: function () {
        ...
        warehouseCombo.load({
            params: {
            	searchType: ComboboxServiceConstants.COMBO_WH_ID, 
                locDivCd: CodeConstants.LOC_DIV_WHO
            },
    ...
    initializeRowBay: function () {
        ...
        if (whId) {
            ...
            warehouseListRow.load({
                ...
                callback: function (records, operation, success) {
                    if (success) {
                        warehouseListRow.insert(0, { locId: 'Select' });
                    }
                }
            });
            //BAY
