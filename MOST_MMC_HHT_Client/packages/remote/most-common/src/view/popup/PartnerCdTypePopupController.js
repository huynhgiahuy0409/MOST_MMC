	...
	getSearchCondition : function(){
    	...
    	var searchKey = '';
     	...
     	if(Ext.isClassic){
    		...
    		{
    			searchKey = me.getView().recvData.ptyCd;
    		}
...
//						}
	...
	onHHTSearch: function() {
		...
		if(me.getView().recvData)
		{
			engPtyNm = me.getView().recvData.ptyCd;
		}
...
//				searchModule: 'MT',
				...
				ptnrName : refs.refPayerCdNmCombo.getValue() !== 'CD' ? refs.refPayerCdNm.getValue() : '',
				ptnrCode : refs.refPayerCdNmCombo.getValue() === 'CD' ? refs.refPayerCdNm.getValue() : '',
