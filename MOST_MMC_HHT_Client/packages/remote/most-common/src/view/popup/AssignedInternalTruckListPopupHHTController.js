Ext.define('MOST.view.popup.AssignedInternalTruckListPopupHHTController', {
	extend: 'MOST.view.foundation.BaseViewController',
	alias: 'controller.assignedinternaltrucklistpopuphht',
	...
	onHHTLoad: function(){
		...
		if(vslCallId != '' && vslCallId != null){
			var store = me.getStore('assignedInternalTruckListPopup');
