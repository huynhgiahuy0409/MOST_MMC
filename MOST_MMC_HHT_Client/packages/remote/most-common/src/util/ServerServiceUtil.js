Ext.define('MOST.util.ServerServiceUtil', {
	singleton: true,
	...
	getPopupStore: function(param){
		var store = Ext.create('MOST.store.Popup');
	...
	// getSotre: function() {
	// 	if(this._store == null)
	// 		this._store = Ext.create('MOST.store.Popup');
	...
	// 		this._storeArray[itemKey] = Ext.create('MOST.store.Popup');
