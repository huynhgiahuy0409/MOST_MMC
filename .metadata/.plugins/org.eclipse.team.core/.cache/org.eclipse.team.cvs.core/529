Ext.define('MOST.view.popup.GateTicketNoPopupController', {
	extend: 'MOST.view.foundation.BaseViewController',

	requires: [
	],

	alias: 'controller.gateticketnopopup',	
	...
	onDblClick: function() {
		...
		var returnItem = {
			code : selection.get("gateTicketNo"),
			codeName : selection.get("gateTicketNo"),
			item : selection
		}
	...
	getReturnData:function(){
		...
		var returnItem = {
			code : selection.data.gateTicketNo,
			item : selectArray
		}
	...
	getSearchCondition : function(){
		...
		var params = {
			...
			gateTicketNo: searchParm.get("gateTicketNo"),
