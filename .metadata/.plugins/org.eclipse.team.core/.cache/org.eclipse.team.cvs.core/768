Ext.define('MOST.view.operation.cargomanualctl.CargoManualCtlTabImport', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.app-cargomanualctltabimport',
	...
	initComponent: function() {
		...
		Ext.apply(me, {
			items: [
		        ...
		        {
		        	xtype: 'tsb-datagrid',
					reference: 'refCargoManualCtlTabImportGrid',
					flex : 1,
					margin: '5 5 5 5',
					gridName:'Import',
					stateful : true,
					stateId : 'stateCargoManualCtlTabImportGrid',
					plugins: [
						'gridexporter',
						'gridfilters',
						'clipboard'
					...
					columns: {
		            	...
		            	items: GridUtil.getGridColumns('CargoManualCtlTabImport')
					}
			    }
			]
		});
