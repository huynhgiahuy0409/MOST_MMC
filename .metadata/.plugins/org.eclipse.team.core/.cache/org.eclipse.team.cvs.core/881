Ext.define('MOST.view.usercontrol.CMMCdField', {
	extend: 'Ext.Container',
	alias: 'widget.cmmcdfield',
	padding: '0,0,0,0',
	
	requires: [
	],

	controller: 'cmmcdfield',
...
//						}
			...
			getCgTpCd:function(){
		 	...
		 	getCmdtGrpCd:function(){
				return this.cmdtGrpCd;
		 	},
		 	
		 	setCmdtGrpCd:function(codeValue){
		 		this.cmdtGrpCd = codeValue;
		 	},
		 	...
		 	setCmdtCd:function(codeValue){
		 		this.cmdtCd = codeValue;
		 	},
