Ext.define("MOST.view.document.excelupload.RORODetailUploadList",{
	extend: "Ext.panel.Panel",
	
    alias: 'widget.app-rorodetailuploadlist',
    ...
    requires: [
   	...
   	controller: 'rorodetailuploadlist',
   	
   	viewModel: {
   		type: 'rorodetailuploadlist'
   	},
   		...
   		Ext.apply(me, {
			...
			items: [{
				...
				columns: {
					...
					items:GridUtil.getGridColumns('RORODetailUploadList')
				}
			}],
	   			...
	   			items: [{
					...
					collapsible:true,
	   				...
	   				items: [{
		        				...
		        				id:'rORODetailUploadListFileUpload',
								...
								bind: {
	                                disabled: '{rORODetailUploadList.data.length === 0 || !validObj.excelItself }'
	                            },
	                            listeners: {
	   	    						click: 'onSave'
	   	    					}
