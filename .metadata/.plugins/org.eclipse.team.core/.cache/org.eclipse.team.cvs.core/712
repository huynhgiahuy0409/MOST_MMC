Ext.define('MOST.view.main.FindPassword', {
	extend: 'Ext.form.Panel',
	
	alias: 'widget.app-findpassword',
	
	requires: [
		'MOST.view.main.FindPasswordModel',
		'MOST.view.main.FindPasswordController',
		'MOST.config.Locale'
	],
	...
	lblUserId: {type: 'bundle', key: 'logUserPassUserId'},
