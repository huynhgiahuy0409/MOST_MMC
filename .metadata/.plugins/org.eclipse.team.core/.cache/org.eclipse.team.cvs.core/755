Ext.define("MOST.view.operation.TheListOfDamageCheckOfGC", {
	extend: "Ext.panel.Panel",

	alias: 'widget.app-thelistofdamagecheckofgc',
	requires: [
		'MOST.view.operation.TheListOfDamageCheckOfGCModel',
		'MOST.view.operation.TheListOfDamageCheckOfGCController',
	...
	controller: 'thelistofdamagecheckofgc',
	viewModel: {
	...
	* CONSTANT START
	*/
	MAIN_GRID_REF_NAME: 'refTheListOfDamageCheckOfGCGrid',
	...
	initComponent: function () {
		...
		Ext.apply(me, {
			...
			items: [{
				xtype: 'tsb-datagrid',
				reference: 'refTheListOfDamageCheckOfGCGrid',
				flex: 1,
				plugins: [
					'gridexporter',
					'gridfilters',
				...
				listeners: {
					celldblclick: 'onDetailGCDamageCheck',
				...
				columns: {
					...
					items: GridUtil.getGridColumns('TheListOfDamageCheckOfGC')
				}
			}
			],
			dockedItems: [{
				...
				},
				{
					...
					fieldLabel: 'app-damagecheckregistration',
