...
public class SpaceMovementPlanDao extends BaseDao implements ISpaceMovementPlanDao {
    ...
    public DataItemList selectSpaceMoveMentPlanDetail(SearchSpaceMovementPlanParm parm) throws DaoException {
        return unifiedDao.getItemsPage("spaceMovementPlan.selectSpaceMoveMentPlanDetail", parm);
    }
    ...
    public void deleteSpcMovRequestItems(TxTraceInfo txTraceInfo, DataItemList items) throws DaoException {
        unifiedDao.deleteItems(txTraceInfo,"spaceMovementPlan.deleteSpaceMovementPlanItems", items);
    }
