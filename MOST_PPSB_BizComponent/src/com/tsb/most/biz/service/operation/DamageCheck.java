...
import com.tsb.most.biz.dao.operation.IDamageCheckDao;
...
public class DamageCheck extends MOSTBaseService implements IDamageCheck{
	private IDamageCheckDao damageCheckDao;
	private IFileUpload fileUpload;

	public void setDamageCheckDao(IDamageCheckDao damageCheckDao) {
		this.damageCheckDao = damageCheckDao;
	}
	...
	public DataItemList selectDamageCheck(SearchDamageCheckParm parm) throws BizException {
		...
		DataItemList items = damageCheckDao.selectDamageCheck(parm);
	...
	public DataItemList insertDamageCheck(InsertItemsBizParm parm) throws BizException {
		...
		DataItemList list = damageCheckDao.selectJobNoDamageCheck(parm);
		...
		return damageCheckDao.insertDamageCheck(parm);
	}
	...
	public DataItemList updateDamageCheck(UpdateItemsBizParm parm) throws BizException {
		...
		return damageCheckDao.updateDamageCheck(parm);
	}
}
