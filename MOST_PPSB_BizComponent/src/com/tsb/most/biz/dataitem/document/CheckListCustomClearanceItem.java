 ...
 */
public class CheckListCustomClearanceItem extends DataItem {
	...
	public String getLastDateStg() {
		return lastDateStg;
	}
	public void setLastDateStg(String lastDateStg) {
		this.lastDateStg = lastDateStg;
	}
