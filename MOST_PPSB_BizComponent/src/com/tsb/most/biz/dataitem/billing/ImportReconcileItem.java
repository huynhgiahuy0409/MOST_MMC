 ...
 */
public class ImportReconcileItem extends DataItem {
    ...
    private ArrayList<ImportReconcileItem> items;
    private ArrayList<ImportReconcileItem> statusitems;
	...
	public ArrayList<ImportReconcileItem> getItems() {
		return items;
	}
	public void setItems(ArrayList<ImportReconcileItem> items) {
		this.items = items;
	}
	public ArrayList<ImportReconcileItem> getStatusitems() {
		return statusitems;
	}
	public void setStatusitems(ArrayList<ImportReconcileItem> statusitems) {
