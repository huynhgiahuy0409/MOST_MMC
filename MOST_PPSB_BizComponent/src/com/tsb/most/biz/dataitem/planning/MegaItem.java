...
public class MegaItem extends DataItem {
    ...
    // DataItemList
	private DataItemList confirmationSlipDryBreakBulk;
    private DataItemList purposeList;
    private DataItemList shiftList;
    private DataItemList patnerList;
    private DataItemList vesselCallIdList;
    private DataItemList megaStatusList;
    private DataItemList cargoTypeList;
    private DataItemList cscPurposeList;
    private DataItemList DetailList;
    private DataItemList cargoDetailOperationList;
    private DataItemList warehouseLocationList;
    private DataItemList cargoDetailList;
    private DataItemList commodityCodeList;
    private DataItemList packageList;
    private DataItemList mechanicalEquipmentTypeList;
    private DataItemList portCraneEquipmentTypeList;
    private DataItemList categoryList;
    private DataItemList workingAreaList;
    private DataItemList companyList;
    private DataItemList gearsRequisitionList;
    private DataItemList forkliftEquipmentList;
    private DataItemList trailerEquipmentList;
    private DataItemList snList;
    private DataItemList doList;
	...
	public DataItemList getPurposeList() {
		return purposeList;
	}
	public void setPurposeList(DataItemList purposeList) {
		this.purposeList = purposeList;
	}
	public DataItemList getShiftList() {
		return shiftList;
	}
	public void setShiftList(DataItemList shiftList) {
		this.shiftList = shiftList;
	}
	public DataItemList getPatnerList() {
		return patnerList;
	}
	public void setPatnerList(DataItemList patnerList) {
		this.patnerList = patnerList;
	}
	public DataItemList getVesselCallIdList() {
		return vesselCallIdList;
	}
	public void setVesselCallIdList(DataItemList vesselCallIdList) {
		this.vesselCallIdList = vesselCallIdList;
	}
	public DataItemList getMegaStatusList() {
		return megaStatusList;
	}
	public void setMegaStatusList(DataItemList megaStatusList) {
		this.megaStatusList = megaStatusList;
	}
	public DataItemList getCargoTypeList() {
		return cargoTypeList;
	}
	public void setCargoTypeList(DataItemList cargoTypeList) {
		this.cargoTypeList = cargoTypeList;
	}
	public DataItemList getCscPurposeList() {
		return cscPurposeList;
	}
	public void setCscPurposeList(DataItemList cscPurposeList) {
		this.cscPurposeList = cscPurposeList;
	}
	public DataItemList getDetailList() {
		return DetailList;
	}
	public void setDetailList(DataItemList detailList) {
		DetailList = detailList;
	}
	public DataItemList getCompanyList() {
		return companyList;
	}
	public void setCompanyList(DataItemList companyList) {
		this.companyList = companyList;
	}
	public DataItemList getMechanicalEquipmentTypeList() {
		return mechanicalEquipmentTypeList;
	}
	public void setMechanicalEquipmentTypeList(DataItemList mechanicalEquipmentTypeList) {
		this.mechanicalEquipmentTypeList = mechanicalEquipmentTypeList;
	}
	public DataItemList getPortCraneEquipmentTypeList() {
		return portCraneEquipmentTypeList;
	}
	public void setPortCraneEquipmentTypeList(DataItemList portCraneEquipmentTypeList) {
		this.portCraneEquipmentTypeList = portCraneEquipmentTypeList;
	}
	public DataItemList getCargoDetailOperationList() {
		return cargoDetailOperationList;
	}
	public void setCargoDetailOperationList(DataItemList cargoDetailOperationList) {
		this.cargoDetailOperationList = cargoDetailOperationList;
	}
	public DataItemList getWarehouseLocationList() {
		return warehouseLocationList;
	}
	public void setWarehouseLocationList(DataItemList warehouseLocationList) {
		this.warehouseLocationList = warehouseLocationList;
	}
	public DataItemList getWorkingAreaList() {
		return workingAreaList;
	}
	public void setWorkingAreaList(DataItemList workingAreaList) {
		this.workingAreaList = workingAreaList;
	}
	public DataItemList getForkliftEquipmentList() {
		return forkliftEquipmentList;
	}
	public void setForkliftEquipmentList(DataItemList forkliftEquipmentList) {
		this.forkliftEquipmentList = forkliftEquipmentList;
	}
	public DataItemList getTrailerEquipmentList() {
		return trailerEquipmentList;
	}
	public void setTrailerEquipmentList(DataItemList trailerEquipmentList) {
		this.trailerEquipmentList = trailerEquipmentList;
	}
	public DataItemList getSnList() {
		return snList;
	}
	public void setSnList(DataItemList snList) {
		this.snList = snList;
	}
	public DataItemList getDoList() {
		return doList;
	}
	public void setDoList(DataItemList doList) {
		this.doList = doList;
	}
	public ArrayList<MegaItem> getItems() {
		return items;
	}
	public DataItemList getCargoDetailList() {
		return cargoDetailList;
	}
	public void setCargoDetailList(DataItemList cargoDetailList) {
		this.cargoDetailList = cargoDetailList;
	}
	public DataItemList getCommodityCodeList() {
		return commodityCodeList;
	}
	public void setCommodityCodeList(DataItemList commodityCodeList) {
		this.commodityCodeList = commodityCodeList;
	}
	public DataItemList getGearsRequisitionList() {
		return gearsRequisitionList;
	}
	public void setGearsRequisitionList(DataItemList gearsRequisitionList) {
		this.gearsRequisitionList = gearsRequisitionList;
	}
	public DataItemList getPackageList() {
		return packageList;
	}
	public void setPackageList(DataItemList packageList) {
		this.packageList = packageList;
	}
	public DataItemList getCategoryList() {
		return categoryList;
	}
	public void setCategoryList(DataItemList categoryList) {
	...
	public DataItemList getConfirmationSlipDryBreakBulk() {
		return confirmationSlipDryBreakBulk;
	}
	public void setConfirmationSlipDryBreakBulk(DataItemList confirmationSlipDryBreakBulk) {
