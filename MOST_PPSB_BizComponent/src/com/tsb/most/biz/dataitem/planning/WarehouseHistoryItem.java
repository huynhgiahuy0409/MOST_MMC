...
public class WarehouseHistoryItem extends DataItem {
    ...
    // LIST - KHH 2019.01.16
    private ArrayList<WarehouseHistoryItem> items;
    private List oprList;
    private List hatchNoList;
    private List packageTypeList;
    
    private ArrayList<WarehouseHistoryItem> whLocCombo;
    private ArrayList<WarehouseHistoryItem> shipgNoteCombo;
    private ArrayList<WarehouseHistoryItem> blCombo;
	...
	public ArrayList<WarehouseHistoryItem> getItems() {
		return items;
	}
	public void setItems(ArrayList<WarehouseHistoryItem> items) {
		this.items = items;
	}
	...
	public ArrayList<WarehouseHistoryItem> getWhLocCombo() {
		return whLocCombo;
	}
	public void setWhLocCombo(ArrayList<WarehouseHistoryItem> whLocCombo) {
		this.whLocCombo = whLocCombo;
	}
	public ArrayList<WarehouseHistoryItem> getShipgNoteCombo() {
		return shipgNoteCombo;
	}
	public void setShipgNoteCombo(ArrayList<WarehouseHistoryItem> shipgNoteCombo) {
		this.shipgNoteCombo = shipgNoteCombo;
	}
	public ArrayList<WarehouseHistoryItem> getBlCombo() {
		return blCombo;
	}
	public void setBlCombo(ArrayList<WarehouseHistoryItem> blCombo) {
