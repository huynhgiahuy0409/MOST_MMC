...
public class CargoJobItem extends DataItem {
    ...
    private String eqPrime;
    private String eqForklift;
    ...
    /**
     * @return Returns the eqPrime.
     */
    public String getEqPrime() {
        return eqPrime;
    }
    /**
     * @param eqNo The eqNo to set.
     */
    public void setEqPrime(String eqPrime) {
        this.eqPrime = eqPrime;
    }
    /**
     * @return Returns the eqNo.
     */
    public String getEqForklift() {
        return eqForklift;
    }
    /**
     * @param eqNo The eqNo to set.
     */
    public void setEqForklift(String eqForklift) {
        this.eqForklift = eqForklift;
    }
    /**
