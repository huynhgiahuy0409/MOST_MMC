...
public class DamageDimensionCheckController extends RestBaseController{
	...
	@ResponseBody
	public RestResponse updateDamageCheck(@PathVariable("id") String id, @RequestBody DamageCheckItem parm) throws ServiceException, Exception{
		RestResponse rtnResponse = new RestResponse();
		UpdateItemsBizParm updateParm = new UpdateItemsBizParm();
		updateParm.setUpdateItem(parm);
		Object result = invokeService("MOST.damageDimensionCheck.processDamageCheckListItem", updateParm);
...
//	}
	...
	@ResponseBody
	public RestResponse selectTheDamageDesc(SearchDamageDimensionCheck parm) throws ServiceException, Exception {
		RestResponse response = new RestResponse();
		Object result = invokeService("MOST.damageDimensionCheck.selectTheDamageDesc",parm);
		response.setData(((DataItemList)result).getCollection());
		return response;
	}
	
	@RequestMapping(value = "/inforblsn", method = RequestMethod.GET)
	@ResponseBody
	public RestResponse selectInforBlSN(SearchDamageDimensionCheck parm) throws ServiceException, Exception {
		RestResponse response = new RestResponse();
		Object result = invokeService("MOST.damageDimensionCheck.selectInforBlSN",parm);
		response.setData(((DataItemList)result).getCollection());
		return response;
	}
}
