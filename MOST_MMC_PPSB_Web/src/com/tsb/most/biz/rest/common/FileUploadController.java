...
public class FileUploadController extends RestBaseController {
	...
	@RequestMapping(value = "/filedownload",method = RequestMethod.PUT)
	@ResponseBody
	public RestResponse selectFileDownload(@PathVariable("id") String id, @RequestBody UpdateBizParm<FileUploadItem> parm) throws ServiceException, Exception {
