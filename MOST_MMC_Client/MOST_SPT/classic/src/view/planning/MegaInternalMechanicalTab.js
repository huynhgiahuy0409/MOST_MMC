Ext.define('MOST.view.planning.MegaInternalMechanicalTab', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.app-megainternalmechanicaltab',
	...
	lblEqType: {type: 'bundle', key: 'capacityEqTpNm'},
	lblCapaDescr: {type: 'bundle', key: 'capacityCapaQty'},
		...
		Ext.apply(me, {
			items: [{
					...
					items:[
						 {
		                    ...
		                    flex: 1,
		                    editable: false,
		                    bind: '{selectedMechanical.megaNo}'
		                },{
		                    xtype: 'textfield',
		                    fieldLabel: 'Capacity',
		                    flex: 2,
		                    editable: false,
		                    bind: '{selectedMechanical.capaDescr}'
		                },{
		                    xtype: 'textfield',
		                    fieldLabel: 'Req.Qty',
		                    flex: 1,
		                    editable: false,
		                    bind: '{selectedMechanical.reqQty}'
		                },{
		                    xtype: 'numberfield',
	                        minValue : 0,
	    					maxValue: 999999,
		                    ...
		                    flex: 1,
		                    allowBlank: false,
		                    bind: '{selectedMechanical.confmQty}'
		                },{
		                    xtype: 'numberfield',
	                        minValue : 0,
	                        maxValue: 999999,
	                        ...
	                        flex: 1,
		                    fieldLabel: 'W/H Qty',
		                    bind: '{selectedMechanical.whQty}'
		                }
					]
				},{
    				xtype: 'grid',
    				reference: 'refMegaInternalMechanicalGrid',
    				flex : 1,
    				margin : '5 0 0 0',
    				stateful : true,
    				stateId : 'stateMegaInternalMechanicalGrid',
    				plugins: [
    					//rowEditing, 
    					'gridexporter',
    					'gridfilters',
    				...
    				listeners: {
    					...
    					cellClick: 'onMechanicalGridClick'
    				},
