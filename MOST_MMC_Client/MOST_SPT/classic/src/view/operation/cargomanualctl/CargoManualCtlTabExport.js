Ext.define('MOST.view.operation.cargomanualctl.CargoManualCtlTabExport', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.app-cargomanualctltabexport',
	...
	initComponent: function() {
		...
		Ext.apply(me, {
			items: [
		        ...
		        {
					xtype: 'tsb-datagrid',
					reference: 'refCargoManualCtlTabExportGrid',
					flex : 1,
					margin: '5 5 5 5',
					stateful : true,
					stateId : 'stateCargoManualCtlTabExportGrid',
					gridName:'Export',
					plugins: [
						'gridexporter',
						'gridfilters',
					...
					columns: {
		            	...
		            	items: GridUtil.getGridColumns('CargoManualCtlTabExport')
					}
			    }
			]
		});
