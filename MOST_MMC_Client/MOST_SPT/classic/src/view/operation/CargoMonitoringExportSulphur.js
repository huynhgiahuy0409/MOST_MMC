Ext.define('MOST.view.operation.CargoMonitoringExportSulphur', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.app-cargomonitoringexportsulphur',
    requires: [
        'MOST.view.operation.CargoMonitoringExportSulphurController',
        'MOST.view.operation.CargoMonitoringExportSulphurModel',
    ...
    controller: 'cargomonitoringexportsulphur',

    viewModel: {
        type: 'cargomonitoringexportsulphur'
    },
                    ...
                    items: [
                        {
                            ...
                            title: ViewUtil.getLabel('snlSulphur'),
                            items: [
                                {
                                    xtype: 'tsb-datagrid',
                                    margin: '5 5 0 0',
                                    reference: me.SNL_GRID_REF_NAME,
                                    stateful: true,
                                    stateId: 'snlSulphurGrid',
                                    flex: 1,
                                    plugins: [
                                        'gridexporter',
                                        'gridfilters',
                                    ...
                                    columns: {
                                        ...
                                        items: GridUtil.getGridColumns('SnlCTCS')
                                    }
                                },
                                {
                                    xtype: 'fieldset',
