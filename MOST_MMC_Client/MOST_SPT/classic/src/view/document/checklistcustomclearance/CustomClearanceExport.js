Ext.define('MOST.view.document.checklistcustomclearance.CustomClearanceExport', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.app-customclearanceexport',
	requires: [
	...
	initComponent: function() {
		...
		Ext.apply(me, {
			items: [{
				xtype: 'grid',
				reference: 'refExportGrid',
				flex : 1,
				height: 600,
				stateful : true,
				stateId : 'stateExportGrid',
				plugins: [
					'gridexporter',
					'gridfilters',
					'clipboard'
