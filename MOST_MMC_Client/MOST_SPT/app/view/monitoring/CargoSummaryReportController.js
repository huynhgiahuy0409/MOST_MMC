Ext.define('MOST.view.monitoring.CargoSummaryReportController', {
	extend: 'MOST.view.foundation.BaseViewController',

	requires: [
	],

	alias: 'controller.cargosummaryreport',
	...
	REPORT_PDF_FILE: 'CargoSummaryReport.jrxml',
	REPORT_PDF_FUNCTION: 'MOST.statisticReport.previewCargoSummaryReport',
	/**
	 * CONSTANT END
	 * =========================================================================================================================
	 */	
	...
	onLoad: function(){
		...
		var searchParm = Ext.create('MOST.model.monitoring.CargoSummaryReport');
	...
	onDblClick: function() {
		...
		me.getView().detailViewAlias = 'app-';
...
//     	}
    	...
    	if(dateCondition != null){
    		params['ataFrom'] = stString;
    		params['ataTo'] = edString;
    	}
