Ext.define('MOST.view.main.FindPasswordController', {
	extend: 'MOST.view.foundation.BaseViewController',

	requires: [
		'MOST.model.common.CheckCommonUser'
	],
	...
	DEFAULT_MODEL : 'MOST.model.common.CheckCommonUser',	// DETAIL MODEL
	nowPage : 0,
	/**
	 * CONSTANT END
	 * =========================================================================================================================
	...
	onFindPasswordLoad : function(){
		console.log('onFindPasswordLoad = ');
		...
		console.log('onFindPassword = ' + title);
		...
		findPwdItem.set('searchUserId', "A123");
		findPwdItem.set('email', "jesus2220@naver.com");
		
		console.log('onFindPassword = ' + findPwdItem);
	...
	onSave: function(){
		...
		console.log('onSave = ' + findPwdItem);
		
		if(infoForm.isValid()){
			console.log('infoForm.isValid() = ' + findPwdItem);
			console.log('findPwdItem.dirty = ' + findPwdItem.dirty );
