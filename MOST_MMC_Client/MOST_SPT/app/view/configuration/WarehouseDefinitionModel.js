Ext.define('MOST.view.configuration.WarehouseDefinitionModel', {
	...
	stores: {
		...
		warehouseTerminalCombo : {
			fields: 'MOST.model.combobox.ComboBoxService',
			storeId: 'warehouseTerminalComboComboStore',
			proxy: {
			    type: 'rest',
			    ...
			    extraParams:{
					...
					scd: CodeConstants.MT_MBSCD_SPT
				}
			},
		},		
		...
		warehouseDtlTerminalCombo : {
			fields: 'MOST.model.combobox.ComboBoxService',
			storeId: 'warehouseDtlTerminalComboStore',
			proxy: {
				type: 'rest',
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/combobox/codeMaster',
				extraParams:{
