Ext.define('MOST.view.document.DGDeclarationController', {
	...
	onLoad:function(){
		...
		}else if(parentView.getXType() === "app-forwardernomination"){
			recvData = me.getView().recvData;
			screenMode = me.CALL_LOCATION_FORWARD_NOMINATE;
	...
	onCancel:function(){
		...
		me.getParentView().getController().onDGCancel();
	},
	...
	onOK:function(){
		...
		if(dgForm.isValid()){
			me.getParentView().getController().saveDGProcess();
