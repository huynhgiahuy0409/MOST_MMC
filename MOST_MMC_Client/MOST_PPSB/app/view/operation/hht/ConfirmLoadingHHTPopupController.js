Ext.define('MOST.view.operation.hht.ConfirmLoadingHHTPopupController', {
...
//		}
	...
	operationSetting : function(){
		...
		isDBK = (recvData.get('cgTpCd') === CodeConstants.MT_CGTP_DBN);
...
//		}
	...
	cudFunctionHHT : function() {
		var me = this;
		var refs = me.getReferences();
		me.setMaskedForm(refs.refFrmCfrmLoading, true);
		...
		updateParm.save({
			callback: function(records, operation, success) {
				if (success) {
					...
					me.setMaskedForm(refs.refFrmCfrmLoading, false);
					window.close(); 
				}
			}
		});
