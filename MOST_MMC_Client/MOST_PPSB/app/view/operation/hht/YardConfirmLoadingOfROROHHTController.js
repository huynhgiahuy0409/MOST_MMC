Ext.define('MOST.view.operation.hht.YardConfirmLoadingOfROROHHTController', {
	...
	alias: 'controller.yardconfirmloadingofrorohhtctl',
	...
	onPopupHHTLoad : function(){
		...
		me.getViewModel().setData({theLoadingYardCheckHHT:unitItem});
	},
	...
	onConfirmLoadingYardCheck: function(){
		...
		var unitItem = me.getViewModel().get('theLoadingYardCheckHHT');
...
//		updateParm.get('items').push(unitItem.data);
	...
	onSearchUnitNo: function(){
		...
		ViewUtil.openCodePopup(this, 'app-findunitlistpopuphht', targetCtl, searchParams);
	},
