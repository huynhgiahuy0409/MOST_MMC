Ext.define('MOST.view.operation.hht.VesselShiftingHHTController', {
...
//		itemArr.push(editItem);
		...
		masterItem.set('stsOpTp', refs.refCboOpeMode.getValue());
...
//		var proxy = masterItem.getProxy();
		...
		masterItem.set('prevAtbDate', Ext.Date.parse(me.getViewModel().get('globalAtb'), formatStr));
		masterItem.set('prevAtuDate', Ext.Date.parse(me.getViewModel().get('globalAtu'), formatStr));
