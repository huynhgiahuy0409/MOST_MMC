Ext.define('MOST.view.popup.EquipmentCdPopupController', {
	...
	onLoad: function(){
		...
		vm.set('isYardTruckChecked', me.getView().recvData.isYardTruckChecked)
		vm.set('isYardTruckDisabled', me.getView().recvData.isYardTruckDisabled)
	...
	onSearch: function() {
		var me = this;
     	...
     	var params;
    	var store = me.getStore('equipmentListPopup');
    	var isYardTruckChecked = refs.refYardTruck.getValue(); 
    	var params = me.getSearchCondition(isYardTruckChecked ? 'YT' : null);
    	if(params == null){
    		return;
    	}
	...
	// Search Condition
	getSearchCondition : function(yardTruck){
		var me = this;
     	var refs = me.getReferences();
     	var eqDivCd = 'TR';
		var isYardTruckChecked = refs.refYardTruck.getValue() || this.getViewModel().get('isYardTruckChecked'); 
     	if (yardTruck === 'YT' || isYardTruckChecked) {
     		 eqDivCd = 'YT';		
     	}
		...
		var params = {
			...
			eqFacNo: refs.txtEqDivCd.getValue()
		}
