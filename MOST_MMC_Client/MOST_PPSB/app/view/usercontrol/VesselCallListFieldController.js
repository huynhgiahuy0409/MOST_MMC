Ext.define('MOST.view.usercontrol.VesselCallListFieldController', {
	...
	alias: 'controller.vesselcalllistfield',	

	/**
	 * =========================================================================================================================
	 * CONSTANT START
	 */
	POPUP_ALIAS : 'popup-vesselcalllistpopup',
	prevJpvc : null,
	/**
	 * CONSTANT END
	 * =========================================================================================================================
	...
	onFieldFocusleave : function(){
		...
		if(StringUtil.isNullorEmpty(fieldValue)){
			if(!StringUtil.isNullorEmpty(me.prevJpvc)){
				me.clearVslCallId();
			}
			return;

		} else if(me.prevJpvc === fieldValue){
			return;
