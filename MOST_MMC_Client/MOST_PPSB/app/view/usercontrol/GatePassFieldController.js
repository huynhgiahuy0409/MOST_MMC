Ext.define('MOST.view.usercontrol.GatePassFieldController', {
	...
	alias: 'controller.gatepassfield',	
	...
	openCodePopup:function(){
		...
		if (StringUtil.isNullorEmpty(lorryNo)) {
			...
			popupAlias = "popup-gatepasspopup";
		}
	...
	onFieldFocusleave : function(){
		var me = this;
    	var store = me.getStore('gatePassPopup');
