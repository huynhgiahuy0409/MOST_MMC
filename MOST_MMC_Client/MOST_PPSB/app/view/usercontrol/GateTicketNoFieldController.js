Ext.define('MOST.view.usercontrol.GateTicketNoFieldController', {
	...
	alias: 'controller.gateticketnofield',	
	...
	openCodePopup:function(){
		...
		if (StringUtil.isNullorEmpty(lorryNo)) {
			...
			popupAlias = "popup-gateticketnopopup";
		}
    	...
    	store.load({
			...
			callback: function(records, operation, success) {
				if (success) {
					if(records.length == 1){
						var returnItem = {
							code : records[0].get('gateTicketNo'),
							item : records[0]
						}
