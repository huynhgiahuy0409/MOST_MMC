Ext.define('MOST.view.codes.BerthBittListController', {
	...
	onLoad:function(){
		...
		var searchParm = Ext.create('MOST.model.codes.SearchBerthBittList');
	...
	onAdd: function(){
		...
		var record = Ext.create('MOST.model.codes.BerthBittList');
		var idx = 0;
