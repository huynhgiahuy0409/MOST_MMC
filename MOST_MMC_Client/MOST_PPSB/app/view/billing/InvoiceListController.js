...
//        }
    ...
    afterSetCodePopupData: function (xtype, targetControl, returnValue, me, parent) {
        ...
        if (targetControl === 'txtDtlVslCallId') {
            if (returnValue != null) {
                refs.ctlDtlScn.setValue(returnValue.item.get('scn'));
            ...
            Ext.Array.forEach(result, function (item) {
                ...
                it.set('scn', refs.ctlDtlScn.getValue());
    ...
    getSearchCondition: function () {
		...
		params['vslCallId'] = refs.txtVslCallId.getValue();
...
//            }
    ...
    //s-BILL-016 Invoice Detailed Report
    onPrintPDF: function () {
        var me = this;
        var recvData = me.recvData;
        var payerType = recvData.get('payTpCd');
        ...
        me.getView().detailViewAlias = 'popup-invoicedetailreportpopup';
        me.openDetailPopup(record);
    }
    //e-BILL-016 Invoice Detailed Report
});