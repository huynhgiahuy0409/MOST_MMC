...
//	
	...
	getSearchCondition : function(){
		...
		var delvTpCd = searchParm.data.delvTpCd;
     	...
     	if(!StringUtil.isNullorEmpty(vslCallId) || !StringUtil.isNullorEmpty(opeClassCd) || !StringUtil.isNullorEmpty(scn)){ 
     		if(!StringUtil.isNullorEmpty(opeClassCd) && (StringUtil.isNullorEmpty(vslCallId) || StringUtil.isNullorEmpty(scn))){
