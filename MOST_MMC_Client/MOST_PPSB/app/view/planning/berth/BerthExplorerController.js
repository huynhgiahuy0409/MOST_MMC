Ext.define('MOST.view.planning.berth.BerthExplorerController', {
	...
	onLoad: function(){
		var me = this,
			...
			metaStore = me.getStore('meta'),
			terminalsStore = me.getStore('terminals'),
			berthsStore = me.getStore('berths'),
			bittsStore = me.getStore('bitts'),
			plansStore = me.getStore('plans'),
			sftPlansStore = me.getStore('sftPlans'),
			berthingStatusStore = me.getStore('berthingStatusCombo'),
			maintenanceBerthsStore = me.getStore('maintenanceBerths'),
			reasonsComboStore = me.getStore('reasonsCombo');
