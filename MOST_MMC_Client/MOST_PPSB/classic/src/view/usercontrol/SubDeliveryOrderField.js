Ext.define('MOST.view.usercontrol.SubDeliveryOrderField', {
	extend: 'Ext.Container',
	alias: 'widget.subdeliveryorderfield',
	padding: '0,0,0,0',
	
	requires: [
	],

	controller: 'subdeliveryorderfield',
	
	viewModel: {
		type: 'subdeliveryorderpopup'
	},
	
	lblDefaultLabel: {type: 'bundle', key: 'SDONo'},
