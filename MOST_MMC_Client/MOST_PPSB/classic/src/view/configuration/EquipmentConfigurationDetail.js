									...
									items: [
										{
											...
											labelWidth: 140,
											flex: 1.9,
											reference: 'refPeriodStart',
											format: MOST.config.Locale.getShortDate(),
											fieldLabel: ViewUtil.getLabel('period'),
											maskRe: /[0-9]/,
											editable: false,
											bind: '{theDetail.periodStart}',
											disabled: true
										},
										{
											xtype: 'datefield',
											format: MOST.config.Locale.getShortDate(),
											margin: '0 0 0 5',
											reference: 'refPeriodEnd',
											maskRe: /[0-9]/,
											editable: false,
											bind: '{theDetail.periodEnd}',
											disabled: true
										}
									]
