Ext.define('MOST.view.document.deliveryorderdetail.SubDeliveryOrderDetail', {
	extend: 'Ext.form.Panel',
	
	alias: 'widget.app-subdeliveryorderdetail',
	
	
	title: 'Sub Delivery Order Detail',
