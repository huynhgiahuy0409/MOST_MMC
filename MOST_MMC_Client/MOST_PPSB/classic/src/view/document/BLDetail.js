		            ...
		            items: [
		            	{
							...
							items: [
								...
								},
				                {
				                    ...
				                    xtype: 'button',
				                    width: 120,
				                    reference : 'ctlCancelApprove',
				                    text: ViewUtil.getLabel('cancelApprove'),
				                    hidden: true,
				                    style: { "background-color": "red" },
				                	listeners:{
				                		click: 'onCancelApproveBL'
				                	}
				                }
							]
						}
