		                ...
		                },
						{
							...
							items: [
								...
								},
								{
									...
									bind: '{theShippingNote.anchorageChk}',
									inputValue: 'Y',
									uncheckedValue: 'N',
									checked: false,
								},
								{
									...
									bind: '{theShippingNote.privateJettyChk}',
									inputValue: 'Y',
									uncheckedValue: 'N',
									checked:false
								},
								{
									...
									bind: '{theShippingNote.tsAprovalYN}',
									inputValue: 'Y',
									uncheckedValue: 'N',
									disabled: true,
			    	    			checked:false
