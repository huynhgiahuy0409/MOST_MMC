Ext.define('MOST.view.document.assigningdriverandtruck.AssigningDriversAndCarTrucksForVehicleROROExport', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.app-assigningdriversandcartrucksforvehicleroroexport',
	requires: [],
	 ...
	 * CONSTANT START
	 */
	MAIN_GRID_REF_NAME: 'refAssignedDriversAndTrucksForVehicleROROExportGrid',  // Main Grid Name 
					...
					items: [
						{
							...
							items: [
								{
									xtype: 'textfield',
									bind: '{theAssigning.dogrNo}',
									fieldLabel: ViewUtil.getLabel('sdoNogrNo'),
									readOnly: true
								},
								{
									xtype: 'textfield',
									bind: '{theAssigning.noOfVin}',
