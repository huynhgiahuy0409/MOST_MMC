...
MessageUtil.show=function(icon, localeTitle, localeMsg, params, callBack){
	...
	if (Ext.platformTags.classic) {
		...
		Ext.MessageBox.buttonText = {
		    ok     : ViewUtil.getLabel('ok'),
		    cancel : ViewUtil.getLabel('no'),
		};
		...
		if(icon == Ext.MessageBox.QUESTION){
...
MessageUtil.questionModern=function(localeTitle, localeMsg, params, callBack){
	MessageUtil.show(Ext.MessageBox.QUESTION, localeTitle, localeMsg, params, callBack);
}
...
MessageUtil.infoToast=function(localeTitle, localeMsg, params){
	MessageUtil.showToast('x-fa fa-info-circle', localeTitle, localeMsg, params);
}
