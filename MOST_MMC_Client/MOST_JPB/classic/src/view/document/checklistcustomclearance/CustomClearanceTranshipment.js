Ext.define('MOST.view.document.checklistcustomclearance.CustomClearanceTranshipment', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.app-customclearancetranshipment',
	requires: [
	...
	initComponent: function() {
		...
		Ext.apply(me, {
			items: [{
				xtype: 'grid',
				reference: 'refTranshipmentGrid',
				flex : 1,
				height: 600,
				stateful : true,
				stateId : 'stateTranshipmentGrid',
				plugins: [
					'gridexporter',
					'gridfilters',
					'clipboard'
