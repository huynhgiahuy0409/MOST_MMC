		            ...
		            items: [
		                ...
		                },
						{
							...
							items: [
								...
								{
									xtype: 'checkboxfield',
									boxLabel: ViewUtil.getLabel('bunkering'),
									reference: 'refBunkeringChk',
									bind: {
										value: '{theShippingNote.bkrChk}'
									},
									inputValue: 'Y',
									uncheckedValue: 'N',
									checked:false,
									listeners: {
										change: 'onBunkeringCheck'
									}
								}
							]
						}
		                    ...
		                    items: [
		                        {
		                            ...
		                            bind:{
		                            	value : '{theShippingNote.contractor}'
		                            },
		                            labelAlign: 'right',
		                            fieldStyle : 'text-transform: uppercase',
		                            labelWidth: 120,
		                    ...
		                    items: [
		                        {
		                            ...
		                            xtype: 'textfield',
		                            flex: 1,
		                            reference :'ctlContractorName',
		                            bind: '{theShippingNote.contractorNm}',
		                            labelAlign: 'right',
		                            labelWidth: 120,
		                            editable: false
		                        }
