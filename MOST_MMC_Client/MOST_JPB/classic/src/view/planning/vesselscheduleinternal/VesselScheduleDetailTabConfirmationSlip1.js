	                ...
	                items: [
		                    	...
		                    	},
								{
		    	                    ...
		    	                    items: [
										...
										},
										{
											xtype: 'numberfield',
											margin: '-2 0 0 0',
											reference: 'refHatchSeq',  
											fieldLabel: ViewUtil.getLabel('sequence'),
											flex: 1,
											bind: {
												value : '{theConfirmationSlip.hatchSeq}'
											},
											// allowBlank: false,
											maxValue: 99, // Maximum 2 digits
											minValue: 0,  // No negative numbers
											enforceMaxLength: true, // Enforce max length
											maxLength: 2,
										}
									]
		                    	},
		                    	...
		                    	},
								{
		    	                    ...
		    	                    items: [
		    	                    	...
		    	                    	},
										{
											...
											margin: '5 0 0 0',
											bind: {
												value : '{theConfirmationSlip.msrmt}'
											}
										},
										{
											xtype : 'numberfield',
		                ...
		                },
		                {
	                        ...
	                        items: [
								{
									xtype: 'button',
									reference:'refBtnRequestTimeCS1',
