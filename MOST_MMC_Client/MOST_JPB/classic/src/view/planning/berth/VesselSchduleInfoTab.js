Ext.define('MOST.view.planning.berth.VesselSchduleInfoTab', {
	...
	VSL_SFT_LIST_GRID_REF_NAME: 'refVesselShiftingListGrid',
	VSL_SFT_LIST_STORE_NAME: 'vslShiftingList',
	/**
	 * CONSTANT END
	 * =========================================================================================================================
	 */
							...
							items: [
								{
									...
									items: [
										{
											xtype: 'tsb-datagrid',
											reference: me.VSL_SFT_LIST_GRID_REF_NAME,
											usePagingToolbar: false,
											stateful: true,
											stateId: 'stateVesselShiftingListGrid',
											bind: {
												store: '{' + me.VSL_SFT_LIST_STORE_NAME + '}',
											},
											listeners: {
												select: 'onClickVesselSchduleList',
											},
											...
											columns: {
												...
												items: GridUtil.getGridColumns('VesselShiftingList'),
											},
										},
									],
								},
											...
											items: [
												{
													...
													bind: {
														value: '{selectedVslShifting.readinessAta}',
													},
													readOnly: true,
													format: MOST.config.Locale.getDefaultDateFormatWithNoSeconds(),
												},
