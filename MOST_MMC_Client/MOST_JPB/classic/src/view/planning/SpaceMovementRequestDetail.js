Ext.define('MOST.view.planning.SpaceMovementRequestDetail', {
	extend: 'Ext.form.Panel',
	alias: 'widget.app-spacemovementrequestdetail',
			...
			items: [
				...
				},
				{
					...
					defaults: {
						...
						margin: '0 5 0 0',
						bind: {
							disabled: '{theDetail.statCd != "" && theDetail.statCd != \'REQ\'}'
						},
					}, 
					items: [
						{
				...
				},
				{
					xtype: 'tsb-datagrid',
					margin: '5 5 0 5',
					reference: 'refSpaceMovementRequestDetailGrid',
					flex: 1,
					stateful: true,
					stateId: 'stateSpaceMovementRequestDetailGrid',
					...
					bind: {
						store: '{spaceMovementRequestDetail}'
					},
					selModel: {
						type: 'spreadsheet',
						cellSelect: false,
