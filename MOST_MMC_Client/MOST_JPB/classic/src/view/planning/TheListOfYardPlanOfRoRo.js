Ext.define('MOST.view.planning.TheListOfYardPlanOfRoRo', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.app-thelistofyardplanofroro',
	
	requires: [
		'MOST.view.planning.TheListOfYardPlanOfRoRoModel',
		'MOST.view.planning.TheListOfYardPlanOfRoRoController',
	...
	controller: 'thelistofyardplanofroro',
	
	viewModel: {
		type: 'thelistofyardplanofroro'
	},
	 ...
	 * CONSTANT START
	 */
	MAIN_GRID_REF_NAME: 'refRoRoYardPlanGrid',  // Main Grid Name 
	MAIN_STORE_NAME: 'roroYardPlanItems',            // Main Store Name
	/**
	 * CONSTANT END
	 * =========================================================================================================================
	 */
		...
		Ext.apply(me, {
			...
			items: [{
				...
				columns: {
	            	...
	            	items: GridUtil.getGridColumns('TheListOfYardPlanOfRoRo')
				}
			}],
