Ext.define('MOST.view.operation.warehouse.WarehouseAllocationForRehandle', {
	extend: 'Ext.panel.Panel',
	
	alias: 'widget.app-warehouseallocationforrehandle',
	...
	controller: 'warehouseallocationforrehandle',
	
	viewModel: {
		type: 'warehouseallocationforrehandle'
	},
				                    ...
				                    items:[{ xtype: 'container',
	                                    ...
	                                    items: [
	                                        ...
	                                        },
	                                        {
	                                            ...
	                                            xtype: 'button',
	                                            ui: 'create-button',
	                                            reference: 'btnRehandleInfoUpdate',
	                                            iconCls: 'fa fa-floppy-o',
	                                            margin: '0 0 0 20',
	                                            width : 80,
	                                            text: 'Update',
                                            	listeners: {
                                            		click: 'onRehandleInfoUpdate'
                                                },
                                                disabled: false
	                                        },
	                                        {
