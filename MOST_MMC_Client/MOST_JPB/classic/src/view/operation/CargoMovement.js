...
//                        }
                        ...
                        },
						{
							...
							reference: 'refYardTrukContractor',
							bind: {
		                    ...
		                    items: [
								{
		                            ...
		                            text: ViewUtil.getLabel('confirmMovementAmt'),
		                        },
		                        {
		                        	xtype : 'numberfield',
		                    ...
		                    items: [
								{
		                            ...
		                            text: ViewUtil.getLabel('confirmMovementPPZB10Bal')
		                        },
		                        {
		                        	xtype : 'numberfield',
		                        	reference: 'ctlMovementZb10BalWgt',
		                            readOnly:true,
		                            flex: 1,
		                            bind:'{theDetail.zb10BalWgt}'
		                        },
		                        {
		                        	xtype : 'numberfield',
		                        	reference: 'ctlMovementZb10BalMsrmt',
		                            readOnly:true,
		                            flex: 1,
		                            bind:'{theDetail.zb10BalMsrmt}'
		                        },
		                        {
		                        	xtype : 'numberfield',
		                        	reference: 'ctlMovementZb10BalPkgQty',
		                            readOnly:true,
		                            flex: 1,
		                            bind:'{theDetail.zb10BalPkgQty}'
		                        },
		                        {
		                            xtype: 'container',
		                            flex: 2
		            ...
		            items:[
		            	{
							...
							columns: {
				            	...
				            	items: [
									...
									{
				            			header: ViewUtil.getLabel('confirmMovementScn'),
				            			dataIndex: 'scn',
				            			reference: 'refConfirmMovementScn',
				            			filter: 'string',
				            			width: 110
				            		},
				            		{
