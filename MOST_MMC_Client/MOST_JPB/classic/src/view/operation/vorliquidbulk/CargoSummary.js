	            	...
	            	items:[{
		            	...
		            	items:[
		            		{
				            	...
				            	items:[
				            		...
				            		,{
										...
										bind: {
			            					store: '{blSnCombo}',
			            					value: '{selectedCargoSummary.blSnNo}',			    
			            				},
										displayField: 'scdNm',
			    	   					valueField: 'scd',
										queryMode: 'local',
		            	...
		            	items:[{
					        ...
					        valueField: 'scd',
    	   					...
    	   					allowBlank: false,
							listeners: {
								change: 'onSelectHoseTp'
							}
            			},
						{
							xtype: 'combo',
							fieldLabel: ViewUtil.getLabel('vorLQ_EquipmentNo'),
							reference: 'refVorEqTp',
							bind: {
								store: '{equipmentComboList}',
								value: '{selectedCargoSummary.eqFacNo}'
							},
							queryMode: 'local',
