Ext.define('MOST.view.billing.ExportReconcileForLiquid', {
    extend: 'Ext.form.Panel',
    alias: 'widget.app-exportreconcileforliquid',
	requires: [
		'MOST.view.billing.ExportReconcileForLiquidController',
		'MOST.view.billing.ExportReconcileForLiquidModel',
	...
	controller: 'exportreconcileforliquid',
	
	viewModel: {
		type: 'exportreconcileforliquid'
	},
			...
			items: [
				 {
					...
					columns: {
						...
						items: GridUtil.getGridColumns('ExportReconcileLiquid')
					}
               },
               {
			        xtype: 'splitter',
		                    ...
		                    items: [
		                        {
		                            ...
		                            columns: {
		            	            	...
		            	            	items: GridUtil.getGridColumns('ExportReconcileLiquid_mf')
		                            }	
		                        }
		                    ]
		                }
