Ext.define('MOST.view.popup.SubDeliveryOrderPopup', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.popup-subdeliveryorderpopup',
	requires: [
	...
	title:"Sub Delivery Order List",
	width: 750,
	height: 400,

	controller: 'subdeliveryorderpopup',
	
	viewModel: {
		type: 'subdeliveryorderpopup'
	},
		...
		Ext.apply(me, {
			items: [{
				...
				columns: {
					...
					items: GridUtil.getGridColumns('SDOPopupList')
				}
			}],
