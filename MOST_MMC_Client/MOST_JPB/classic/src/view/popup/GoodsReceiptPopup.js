Ext.define('MOST.view.popup.GoodsReceiptPopup', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.popup-goodsreceiptpopup',
	requires: [
	...
	controller: 'goodsreceiptpopup',
	
	viewModel: {
		type: 'goodsreceiptpopup'
	},
	...
	initComponent: function() {
		...
		Ext.apply(me, {
			items: [{
				...
				margin: '5 5 5 5',
				stateful : true,
				stateId : 'stateGoodsReceiptPopupGrid',
				...
				columns: {
					...
					items: GridUtil.getGridColumns('GoodsReceiptPopupList')
				}
			}],
