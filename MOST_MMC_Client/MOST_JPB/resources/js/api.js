...
//    "url": MOST.config.Locale.getDirectApiDestUrl() + "/router",
    "type": "remoting",
    "actions": {
        "stowage": [{
            "name": "selectStowage",
...
Ext.POLLING_MESSAGE_API = {
    ...
    "type": "polling",
//    "url": MOST.config.Locale.getDirectApiDestUrl() + "/poll/pollingHandler/getMessage/event1",
    "interval": 5 * 1000
};
...
Ext.POLLING_SHARING_API = {
	...
	"type": "polling",
//	"url": MOST.config.Locale.getDirectApiDestUrl() + "/poll/pollingHandler/shareMessage/event2",
	"interval": 5 * 1000
};
...
Ext.POLLING_OSPIF_API = {
	...
	"type": "polling",
//	"url": MOST.config.Locale.getDirectApiDestUrl() + "/poll/pollingHandler/getOspInterfaceMessage/event3",
	"interval": 3 * 1000
};
