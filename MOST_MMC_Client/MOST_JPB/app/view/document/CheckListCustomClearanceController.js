Ext.define('MOST.view.document.CheckListCustomClearanceController', {
	...
	getSearchCondition : function(){
		var me = this;
     	...
     	if(!refs.ctlScn.getValue() && !refs.ctlVslCallId.getValue() && !(refs.ctlETAFromDt.getValue() && refs.ctlETAToDt.getValue())){
			MessageUtil.warning('warning_msg','Ship Call No, Vessel Call No or Date must be inputted.');
			return null;
		}
     	
     	if(refs.ctlVslCallId.getValue() || refs.ctlScn.getValue()){
