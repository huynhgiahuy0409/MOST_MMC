...
//		me.setDateInDays('ctlToDt',0);
	...
	getSearchCondition : function(){
    	...
    	if(StringUtil.isNullorEmpty(searchParm.data.vslCallId) && StringUtil.isNullorEmpty(searchParm.data.scn)){
        	MessageUtil.warning("Terminal Hold Release Control", "goodsreceipt_jpvc_input_msg");
    		return;
        }
