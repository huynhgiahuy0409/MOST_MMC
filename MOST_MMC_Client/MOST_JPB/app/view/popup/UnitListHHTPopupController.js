Ext.define('MOST.view.popup.UnitListHHTPopupController', {
	extend: 'MOST.view.foundation.BaseViewController',

	requires: [
	],

	alias: 'controller.unitlisthhtpopup',
	searchType: '',
	/**
	 * =========================================================================================================================
	...
	onPopupHHTLoad : function(){
		var me = this;
     	...
     	me.getView().up('window').setTitle(params.title);
		...
		var me = this;
     	...
     	if(me.getView().recvData.data) {
			...
			var blNo = unitItem.data.blNo;
	     	...
	     	if(unitItem.data.title){
	     		title =  unitItem.data.title;
	     	}
     	}else {
