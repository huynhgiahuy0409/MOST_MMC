Ext.define('MOST.view.planning.DeploymentListController', {
	...
	getSearchCondition:function(){
		...
		if(StringUtil.isNullorEmpty(searchParm.get('scn')) && StringUtil.isNullorEmpty(serviceDate.dateString) && StringUtil.isNullorEmpty(searchParm.get('vslCallId')) && StringUtil.isNullorEmpty(searchParm.get('staffNo'))
