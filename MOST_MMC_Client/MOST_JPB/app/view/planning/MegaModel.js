Ext.define('MOST.view.planning.MegaModel', {
	...
	stores: {
		...
		megaDetailStevedore: {
			model: 'MOST.model.planning.Mega',
			storeId: 'megaDetailStevedoreStore',
			proxy: {
				type: 'rest',
				showProgressBar : false,
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/mega/manpowerList',
				extraParams:{
					divCd: CodeConstants.MT_EQTP2_SD
				}
			},
		},

		megaDetailTabStevedoreCompany: {
			model: 'MOST.model.planning.OperInfo'
		},

		megaDetailTabTrimmingCompany: {
			model: 'MOST.model.planning.OperInfo'
		},

		megaDetailTrimming: {
			model: 'MOST.model.planning.Mega',
			storeId: 'megaDetailTrimmingStore',
			proxy: {
				type: 'rest',
				showProgressBar : false,
				url: MOST.config.Locale.getRestApiDestUrl() + '/v1/mega/manpowerList',
				extraParams:{
					divCd: CodeConstants.MT_EQTP2_TM
				}
			},
		},
