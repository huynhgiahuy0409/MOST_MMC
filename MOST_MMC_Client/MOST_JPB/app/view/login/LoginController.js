Ext.define('MOST.view.login.LoginController', {
	...
	setDefaultLoad: function() {
		...
		footerImg.src  = '../packages/remote/most-ppsb/resources/images/background/brands_most.png';
		var footerWidth = 1295;
		var footerHeight = 58;

//		switch (branch) {
//			case 'MOST_ZPGC1':
//				me.getView().cls = 'login_body_zp';
//				footerImg.src = './resources/images/background/brands_most_adp_zp.png';
//				break;
//			case 'MOST_FPFT1':
//				me.getView().cls = 'login_body_ft';
//				footerImg.src = './resources/images/background/brands_most_adp_ft.png';
//				break;
//			case 'MOST_FPGC1':
//				me.getView().cls = 'login_body_fp';
//				footerImg.src = './resources/images/background/brands_most_adp_fp.png';
//				break;
//			case 'MOST_KPGC1':
//				me.getView().cls = 'login_body_kp';
//				footerImg.src = './resources/images/background/brands_most_adp_kpgc1.png';
//				break;
//			case 'MOST_MGGC1':
//				me.getView().cls = 'login_body_mg';
//				footerImg.src = './resources/images/background/brands_most_adp_mggc1.png';
//				break;
//			case 'MOST_MPGC1':
//				me.getView().cls = 'login_body_mp';
//				footerImg.src = './resources/images/background/brands_most_adp_mpgc1.png';
//				break;
//			case 'MOST_SPGC1':
//				me.getView().cls = 'login_body_sp';
//				footerImg.src = './resources/images/background/brands_most_adp_spgc1.png';
//				break;
//			default:
//				me.getView().cls = 'login_body';
//				//me.getView().cls = 'login_body_zp';
//				break;
//		}
//		
//		refs.branch.setValue(branch);
//		refs.refLoginFooterImage.setSrc(footerImg.src);
//		refs.refLoginFooterImage.setWidth(footerWidth);
//		refs.refLoginFooterImage.setHeight(footerHeight);
	},
