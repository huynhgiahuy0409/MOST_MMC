Ext.define('MOST.view.usercontrol.SubDeliveryOrderFieldController', {
	...
	alias: 'controller.subdeliveryorderfield',	
	...
	openCodePopup:function(){
		...
		if (StringUtil.isNullorEmpty(lorryNo)) {
			...
			popupAlias = "popup-subdeliveryorderpopup";
		}
	...
	onFieldFocusleave : function(){
		var me = this;
    	var store = me.getStore('subDeliveryOrderPopup');
