Ext.define('MOST.view.popup.ColumnSettingPopup', {
	extend: 'Ext.form.Panel',
	alias: 'widget.popup-columnsettingpopup',
	requires: [
		'MOST.view.popup.ColumnSettingPopupModel',
		'MOST.view.popup.ColumnSettingPopupController',
...
//		'Ext.grid.selection.SpreadsheetModel'
	...
	lblGridName: {type: 'bundle', key: 'gridName'},
   		    			  ...
   		    			  viewConfig:{
   		    		        ...
   		    		        listeners:{
   		    		         'beforedrop': function(node, data, overModel, dropPosition,  dropFunction,  eOpts ){
   		    		        	 if(data.records[0].data.columnDataIndex.indexOf('group')!=-1){
   		    		        		 return false;
   		    		        	 }else{
   		    		        		 return true;
   		    		        	 }
   				...
   				},
   				{
	                ...
	                defaults: {
   					...
   					items : [
   						{
                    		xtype: 'combobox',
                    		reference: 'ctlColumnSettingPopupGridCombo',
                    		fieldLabel: me.lblGridName,
                    		labelWidth:70,
                    		bind: {
                    			store: '{' + me.GRID_COLUMN_STORE_NAME + '}',
                    			value : '{theDetail.gridReference}'
                    		},
                    		queryMode: 'local',
                    		displayField: 'gridName',
                    		valueField: 'gridReference',
                    		allowBlank: false,
                    		maxLength: 50,
							enforceMaxLength : true,
							listeners: {
   		    					change: 'onColumnSettingGridComboChange'
   		    	    		},
                    		width: 230
