Ext.define('MOST.view.popup.SearchConditionPopupController', {
	extend: 'MOST.view.foundation.BaseViewController',

	requires: [
		'MOST.model.common.SearchCondition'
	],
	...
	DETAIL_MODEL_FULL_NAME : 'MOST.model.common.SearchCondition',	// DETAIL MODEL
	DETAIL_ITEM_PROXY_URL : MOST.config.Locale.getRestApiDestUrl() + '/v1/searchCondition/searchItems',	// DETAIL ITEM PROXY URL
	PREFIX_STRING : 'ctl',
	/**
	 * CONSTANT END
	 * =========================================================================================================================
	...
	generateGridColumn : function(searchConditionStore){
        ...
        grid.setStore(searchConditionStore);
		
		grid.reconfigure(reconfigureColumns);
	},
		...
		for (var controlName in selection.data){
			...
			if(control){
				if (control.xtype === 'datetimefield'){
					controlValue = Ext.util.Format.date(controlData.value, MOST.config.Locale.getDefaultDateFormatWithNoSeconds());
				} else {
